...
export const SEED_QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    options: ['Grados A y B', 'Solamente Grado D', 'Grados C y D', 'Cualquier grado con síntomas'],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ['5-10%', '20-30%', '40-50%', '80-100%'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['7 días', '10 días', '14 días', '21 días'],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ['Abscesos crípticos', 'Plasmocitosis basal', 'Granulomas no caseificantes', 'Depleción de mucina'],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ['Falla orgánica persistente (> 48h)', 'Falla orgánica transitoria (< 48h) o complicaciones locales', 'Dolor abdominal refractario', 'PCR > 150 mg/dL'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['OLGIM 0', 'OLGIM I', 'OLGIM II', 'OLGIM III/IV'],
    correctIndex: 3,
  ...
  },
  {
    ...
    options: ['Reiniciar prednisona a dosis altas', 'Cambiar a Micofenolato Mofetil', 'Realizar biopsia hepática inmediata', 'Reiniciar el esquema anterior con dosis de mantención indefinida'],
    correctIndex: 3,
  ...
  },
  {
    ...
    options: ['IRP elevado con 100% de peristalsis fallida', 'IRP elevado con panpresurización esofágica en ≥20% de las degluciones', 'IRP elevado con contracciones prematuras (DLP < 4.5s)', 'IRP normal con ausencia de contractilidad'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['Inmediatamente al diagnóstico de la infección', 'Primeras 48 horas tras el inicio del dolor', 'Después de 4 semanas, cuando la colección está "walled-off"', 'Solo si falla el drenaje percutáneo inicial'],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ['Restricción de sodio + Espironolactona ± Furosemida', 'Paracentesis evacuadora total inicial', 'Transplante hepático de urgencia', 'Shunt portosistémico intrahepático transyugular (TIPS)'],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ['Cicatrización mucosa (endoscópica)', 'Remisión clínica y normalización de la PCR/Calprotectina', 'Calidad de vida normalizada', 'Ausencia de discapacidad'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['HBeAg (+), ADN-VHB > 20,000 UI/mL, ALT normal', 'HBeAg (-), Anticuerpo anti-HBe (+), ADN-VHB < 2,000 UI/mL, ALT normal', 'HBeAg (+), ADN-VHB elevado, ALT elevada', 'HBsAg (-), Anti-HBc (+), ADN-VHB indetectable'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['Azatioprina', 'Ácido Obetivólico', 'Prednisona', 'Ciclosporina'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['Inflamación pericólica limitada (flemón)', 'Absceso pélvico, retroperitoneal o a distancia', 'Peritonitis purulenta generalizada', 'Peritonitis fecal generalizada'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['Ablación por radiofrecuencia inmediata', 'Repetir endoscopia en 6 meses', 'Seguimiento endoscópico cada 3 a 5 años', 'Esofaguectomía distal'],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ['> 250 PMN/mm³ en líquido ascítico', 'Cultivo positivo para E. coli', 'Proteínas totales < 1 g/dL', 'Glucosa < 50 mg/dL'],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ['En 1 año', 'En 3 años', 'En 5 años', 'En 10 años'],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ['Apoptosis', 'Mitosis', 'Citocinesis', 'Senescencia'],
    correctIndex: 3,
  ...
  },
  {
    ...
    options: ['Poliposis Juvenil', 'Síndrome de Cowden', 'Síndrome de Peutz-Jeghers', 'Cáncer Gástrico Difuso Hereditario'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['Mutación Missense', 'Mutación Nonsense', 'Mutación Silente', 'Inserción'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['Secretar proteínas antibacterianas', 'Producir proteasas digestivas', 'Endocitosis de antígenos luminales', 'Absorción de nutrientes'],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ['Componente secretor', 'Receptor de Ig polimérico', 'Cadena J', 'Fragmento Fc'],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ['Lámina propia', 'Muscularis mucosa', 'Submucosa', 'Serosa'],
    correctIndex: 0,
  ...
  },
  {
    ...
    topic: 'vias_biliares',
    difficulty: 'Fellow',
    text: '¿Cuál es el principal determinante del pronóstico tras realizar una corrección quirúrgica (Kasai) en un recién nacido con Atresia Biliar?',
    options: ['Tipo de atresia biliar', 'Estado nutricional materno', 'Gravedad de anomalías cardíacas', 'Nivel de bilirrubina transitoria'],
    correctIndex: 2,
    explanation: 'La supervivencia a largo plazo en la atresia biliar corregida depende críticamente de la presencia y gravedad de malformaciones cardíacas asociadas.',
    fisiopato: 'La atresia biliar es a menudo parte de un síndrome de malformaciones esplénicas (situs inversus, poliesplenia).',
    clinicalPearl: 'Si el procedimiento de Kasai falla antes de los 2 años, el trasplante hepático es la única opción.',
    guideline: 'Sleisenger Review 11th Ed, Cap 8',
    whyWrong: {
      0: 'Influye, pero las anomalías sistémicas dominan el pronóstico.',
      1: 'No tiene impacto directo en el cierre ductal.',
      2: 'Factor pronóstico sistémico principal en estos infantes.',
      3: 'Es una consecuencia, no el factor causal determinante.'
    }
  },
  {
    id: 'seed_29',
    ...
    options: ['Células acinares', 'Células ductales', 'Células estelares pancreáticas', 'Células Alfa'],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ['Tripsina', 'Quimotripsina', 'Elastasa', 'Lipasa'],
    correctIndex: 3,
  ...
  },
  {
    ...
    options: ['Norfloxacino 400mg/día', 'Ciprofloxacino 500mg/semana', 'Rifaximina 550mg/12h', 'Amoxicilina/Clavulánico'],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ['Falla orgánica persistente (>48h)', 'Falla orgánica transitoria (<48h) o complicaciones locales', 'Presencia de necrosis amurallada (WON)', 'Nivel de Lipasa > 10 veces el normal'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['Vigilancia cada 2 años', 'Biopsia y seguimiento si no hay displasia', 'Resección endoscópica completa', 'Tratamiento con IBP y reevaluar'],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ['Miotomía de Heller Laparoscópica', 'Miotomía Endoscópica Peroral (POEM)', 'Dilatación Neumática con balón de 30mm', 'Inyección de Toxina Botulínica'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['Inestabilidad de Microsatélites', 'Inestabilidad Cromosómica (Mutación APC)', 'Metilación de islas CpG', 'Mutación de BRAF'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['Xeroftalmía', 'Manchas de Bitot', 'Ceguera nocturna (Nictalopía)', 'Hiperqueratosis folicular'],
    correctIndex: 2,
  ...
  },
  {
    ...
    topic: 'pediatria',
    difficulty: 'Staff',
    text: 'Un lactante de 3 semanas presenta vómitos en proyectil, no biliosos, tras cada toma. Se palpa una masa en el epigastrio derecho. ¿Cuál es el diagnóstico más probable?',
    options: ['Atresia Duodenal', 'Estenosis Pilórica Hipertrófica', 'Reflujo Gastroesofágico Grave', 'Vólvulo de intestino medio'],
    correctIndex: 1,
    explanation: 'La estenosis pilórica hipertrófica típicamente debuta entre la 3ra y 6ta semana de vida con vómitos no biliosos y la "oliva" pilórica palpable.',
    fisiopato: 'La hipertrofia de las fibras musculares del píloro obstruye mecánicamente el vaciamiento gástrico.',
    clinicalPearl: 'El diagnóstico confirmatorio es ecográfico y el tratamiento es la piloromiotomía de Ramstedt.',
    guideline: 'NASPGHAN Guidelines',
    whyWrong: {
      0: 'Vómitos suelen ser biliosos y presentes desde el día 1.',
      1: 'Cuadro clínico patognomónico.',
      2: 'Vómitos no suelen ser tan explosivos ni persistentes.',
      3: 'Urgencia quirúrgica con vómitos biliosos y compromiso sistémico.'
    }
  },
  {
    id: 'seed_39',
    ...
    options: ['Anti-HBs', 'HBsAg', 'HBeAg', 'Anti-HBc IgM'],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ['Esofaguectomía de urgencia', 'Vigilancia estrecha cada 3 meses', 'Terapia ablativa endoscópica (ej. RFA)', 'IBP a dosis máximas únicamente'],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ['> 100 PMN/mm³', '> 250 PMN/mm³', '> 500 PMN/mm³', '> 1000 PMN/mm³'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['Cistoadenoma Seroso', 'Psedoquiste Pancreático', 'Neoplasia Quística Mucinosa', 'Tumor de Frantz'],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ['Atrofia severa en el antro con preservación del cuerpo', 'Atrofia severa en el cuerpo con preservación del antro', 'Pangastritis con agregados linfoides', 'Gastritis erosiva hemorrágica'],
    correctIndex: 1,
  ...
  },
  {
    ...
    topic: 'motilidad',
    difficulty: 'Staff',
    text: 'Según la Clasificación de Chicago v4.0, ¿cuál es el criterio manométrico indispensable para el diagnóstico de Obstrucción del Flujo de la Unión Esofagogástrica (EGJOO)?',
    options: ['IRP elevado con peristalsis normal', 'IRP normal con ausencia de peristalsis', 'DCI > 8000 con IRP normal', 'Ondas spásticas con IRP elevado'],
    correctIndex: 0,
    explanation: 'La EGJOO se define por un IRP elevado (preshub de relajación) pero con presencia de peristalsis intacta o fragmentada (no cumple criterios de acalasia).',
    fisiopato: 'Representa una resistencia mecánica o funcional al vaciamiento esofágico en el esfínter inferior.',
    clinicalPearl: 'Antes de diagnosticar EGJOO funcional, siempre descarte una causa mecánica (ej. hernia hiatal o estenosis) mediante EGD o TAC.',
    guideline: 'Chicago Classification v4.0',
    whyWrong: {
      0: 'Definición formal de EGJOO.',
      1: 'Compatible con aperistalsis inespecífica.',
      2: 'Define Esófago de Jackhammer.',
      3: 'Sugeriría Acalasia Tipo III.'
    }
  },
  {
    id: 'seed_45',
    ...
    options: ['Propranolol únicamente', 'Carvedilol', 'Nadalol + Nitratos', 'Somatostatina crónica'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['Abscesos criptas', 'Granulomas no caseificantes', 'Distorsión de la arquitectura de las criptas', 'Metaplasia de células de Paneth'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['FIT (Inmunoquímica)', 'gFOBT (Guayaco)', 'sDNA-FIT (Cologuard)', 'Septina 9 plasmática'],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ['Micofenolato de Mofetilo', 'Ciclosporina', 'Infliximab', 'Tacrolimus'],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ['1 año', '3 años', '3 a 5 años', '10 años'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['Ácido Ursodesoxicólico', 'Vigilancia ecográfica anual', 'Colecistectomía', 'CPRE con esfinterotomía'],
    correctIndex: 2,
