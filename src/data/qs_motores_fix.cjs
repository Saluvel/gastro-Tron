...
const generateMotores = () => {
  ...
  for (let i = 9; i <= 30; i++) {
    ...
    qs.push({
      ...
      difficulty: 'Fellow',
      text: `¿Cuál es la característica principal de la alteración motora esofágica número ${i} según los hallazgos en la manometría de alta resolución (Chicago 4.0)?`,
      options: [
