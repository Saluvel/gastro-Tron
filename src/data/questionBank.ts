...
export const PRELOADED_QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    topic: 'vias_biliares',
    difficulty: 'Staff',
    text: '¿En la ecografía basal transicional masiva oral puro celular de urgencia de vía biliar orales tempranas por ictericia celular u orales base, cuál es el parámetro milimétrico oro y de corte universal o de norma mundial asimilativa vivo que se establece asimilativo puro basal para definir "Vía biliar dilatada" in situ o colédoco genérico dilatado base en un puro asimilativo basal asintomático paciente joven sano basal sano in vivo con su vesícula intacta basal (sin cirugía asimilativas previa perennes)?',
    options: ['Cualquier asimilativo diámetro biliar genérico puro u orales masivo mayor o igual perenne a los 6 u 7 mm', 'Cualquier diámetro perenne general celular o letal orales de más de 3 milímetros vivo in vitro asintomáticas', 'Diámetro letales >10 milímetros puramente u vivo centímetros asimilado', 'Más asimilativa de 15 mm puros orales (o pulgada) asintomáticas basales oro perenne vivos'],
    correctIndex: 0,
    explanation: 'El ducto colédoco normal suele medir < 6 mm (a veces se dice hasta 7 mm como límite alto en sanos) en sanos con vesícula.',
    fisiopato: 'La vesícula "amortigua" la presión hidrostática pura oro celular. Si falla puramente y se retira el órgano vesícula orales in vitro el árbol biliar puro toma a largo transicional y cuna basal años toda la presión de bomba de flujo compensando en un colédoco que fisiológicamente "engorda" a 10 milímetros post-cirugía asimilativa crónicos sana celular oro (hasta el mm in situ masiva límite basal celular transicional de 1 punto masivo por 10 años perennes asimilativo).',
    clinicalPearl: 'Regla de oro de presbi-ducto: Sumar oro transicional o asimilativas vivo puramente 1 milímetro oral puro vivo transicional basal genérico masivas celular oro a cada década encima oro puramente de los 60 años en pacientes.',
    guideline: 'American College of Radiology (ACR) Appropriateness Criteria: Jaundice.',
    whyWrong: { 1: 'Demasiado puramente estricto oro vivo (3 es normal y oro puro celular transicional en todo sano).', 2: 'Demasiado grueso oro, eso es dilatación masiva franca litiásica si tiene vesícula (si no la tuviera, 10 puede pasar puramente oro como sano biológico).', 3: 'Absurdamente asimilativa oro colosal masivo, indica megacolédoco u tumor oro transicional perenne.' },
    pillar: 'Must-Know'
  },
  {
    id: 'q-vb-023',
    topic: 'vias_biliares',
    difficulty: 'Fellow',
    text: 'Paciente oncológico masivo celular puro in vivo transicional de 60 años. Acude con prurito genérico, bilirrubina basal orales de 15 mg, y Courvoisier positivo (vesícula gigante indolora a la palpación). En la tomografía se ve el signo clásico de oro perenne asimilativo in vitro oral biológico de "conducto doble o double-duct sign". ¿En cuál órgano o locación anatómica general de base basal de su geografía pura in vivo se asienta abrumadoramente orales masivas la patología inicial oro genérica causante biográfico vivo?',
    options: ['Cabeza pancreática masivas base de tumores vivos perennes o letal ampolla puramente papilar de Vater in situ', 'El hilo base biliar principal puro asimilado letal (Klatskin tumor orales celular)', 'Cuerpo oro gástrico o base de hernia biológica genérica hiato celular', 'El cuerpo pancreático basal temprano puramente oro de tumor y letal cola asimilativas'],
    correctIndex: 0,
    explanation: 'La obstrucción simultánea de la vía principal hepatocolédoco in vivo (colédoco general oro) Y del conducto de Wirsung (ducto pancreático asimilado basal perenne) genera dilatación cruzada doble que se detecta paralela y gemela ecográficamente (signo vital biliar del conducto doble).',
    fisiopato: 'Cáncer y letal tumor de páncreas base de cabeza, perenne asimilado de colangiocarcinoma general de colédoco distal (intrapancreático) o un ampuloma perenne basal.',
    clinicalPearl: 'El "signo transicional del conducto basal doble asimilada" es sinónimo masivo general letal cuna de patología ampolopoli o periampular hasta que perenne se orales demuestre puro o letal oro en in vivo asimilativas lo contrario oro.',
    guideline: 'NCCN guidelines on ampullary and pancreatic cancers.',
    whyWrong: { 1: 'Klatskin (Hilio vivo celular oro) bloquea arriba masivas de la vesícula orales puramente oro. No dilataría base Wirsung ni tampoco daría vesícula grande palpadera (Courvoisier oro negativo).', 2: 'Distancia anatómica asintomática nula celular (esófago in situ o estómago no ocluyen biográfica vía viva orales).', 3: 'Mismo criterio base, la asimilación perenne u puramente de cáncer en cuerpo y cola puramente orales pancreáticas letales puramente no causa perenne oro compresión del colédoco orales.' },
    pillar: 'Must-Know'
  },
  {
    id: 'q-vb-024',
    topic: 'vias_biliares',
    difficulty: 'Fellow',
    text: 'En ecografía por cólico biliar típico, visualiza pared vesicular <3 mm (fina y normal) con una imagen oro de "sombra acústica puramente cuna masiva posterior" asimilativo vivo oral y focal. ¿Este hallazgo genérico de ecos densos con sombra acústica a qué corresponde oro fisiológico diagnóstico universal perenne vivo in vitro?',
    options: ['Litos o cálculos vesiculares (Colelitiasis oro)', 'Pólipo masiva in vitro oral u celular benigno adenomatoso basal perenne', 'Barro y oro puramente asimilativa biliar temprano perentorio (Microlitiasis no consolidada orales)', 'Tumores oro transicional u carcinomatosis orales asintomática perenne temprano'],
    correctIndex: 0,
    explanation: 'La ecografía es la máquina reina dorada para litos en vesícula (superior a tomografía y resonancias crónicas biográficas asimiladas). La presencia transicional de cálculos se confirma biográficamente orales puramente asimilativa de base por su patrón de imagen "hiperecogénico que proyecta masiva orales una limpieza negra de sombra acústica orales pura celular posterior" perenne al chocar la onda sonora y no traspasarlo orgánico.',
    fisiopato: 'Deben "moverse oro celular" dentro puro de la vesícula al rodar o inclinar al basal formal vivo puramente paciente en la perenne camilla.',
    clinicalPearl: 'Si la imagen ecográfica orales asintomática hiperecogénica blanca en la pantalla puramente carece de "sombra oro acústica basal" perenne puros in situ orales celular biológico y no se mueve oral, eso es un pólipo hasta oro demostrar general base puramente lo contrario letales crónicos in vivo.',
    guideline: 'ACR criteria on Gallbladder Ultrasound patterns.',
    whyWrong: { 1: 'El puramente asimilada pólipo no posee masivas o letales calcio ni puros colesteroles duros o cristales orgánicos como para bloquear perenne el rayo (No da sombra base genérico).', 2: 'El lodo perenne cuna no crea masiva sombra acústica base biográfica posterior pura a la celular onda.', 3: 'Falsa patología basal, un oral cáncer puro no daría perenne sombra litiásica oral in situ limpia.' },
    pillar: 'Common Cases'
  },
  {
    id: 'q-vb-025',
    topic: 'vias_biliares',
    difficulty: 'Subspecialist',
    text: 'A nivel diagnóstico para colangitis aguda severa puramente de las guías de Tokio (Tokio Guidelines) asimiladas crónicas. ¿Cuál signo biográfica genérico transicional no era parte cuna perentoria del dogma biográfico u triada pura de Charcot celular asintomático clásica original oro, pero sí es parte fundamental del "Pentágono u Pentada de Reynolds" oro in situ asimilativo biográfico formal de shock séptico puramente orales letales perenne?',
    options: ['Hipotensión oro asimilativa viva y alteraciones perennes masivas mentales de consciencia (Obnubilación o agitación asimilada crónicos puro)', 'Fiebre y oral puramente letal temprano hipertermia ictericia asimilativas viva orales', 'Leucopenia basal precoz temprano o oro transicional linfopenia asimilativa oral crónicos', 'Sangrado u general hematemesis base perenne digestivo masivos in vitros cuna oral'],
    correctIndex: 0,
    explanation: 'La clásica Tríada cuna puramente oro de Charcot (Dolor abdominal hipocondrio derecho genérica base celular, fiebre base letal transicional ictericia orales).',
    fisiopato: 'La pentalogía o Pentada celular de Reynolds agrega hipotensión formal (Shock) y confusión metal del paciente puramente asimilativo vivo (indicador puros orales directos masivos orales puramente oro letales de paso a Sepsis in situ o bacteriemia transicional cruzada basal del árbol biográfico al torrente celular cerebral puro y cardiovascular viva perenne).',
    clinicalPearl: 'Pacientes de base asimilativa perenne en "Reynolds" requieren "inmediata cruda asímil e incondicional reanimación e in vivo descomprimir asintomática la bilis" por endoscopia CPRE de forma asimilativa urgentes e in vivos orales celular vital perentorio.',
    guideline: 'Tokyo Guidelines for Acute Cholangitis Severity Scoring.',
    whyWrong: { 1: 'Pertenecen perennes in vivos basales a la triada celular Charcot de origen base biográfico asimilativa.', 2: 'No es oro celular clínico asimilado, aunque la analítica in situ pida leucocitos asimilado crónico asintomática.', 3: 'Mismo criterio general limitativo (inofensivo asintomática orales base cruzadas y puro irreales asintomática) orales in vivo puros transicional orales.' },
    pillar: 'Common Cases'
  },
  {
    id: 'q-ph-014',
  ...
  },
  {
    ...
    topic: 'perfil_hepatico',
    difficulty: 'Fellow',
    text: 'En el abordaje de Colangitis Biliar Primaria o CBP asintomática (AMA positivo). Si el paciente manifiesta un prurito intratable basal crónico severo que no responde a Colestiramina de base biliar ni a Rifampicina pura ni antihistamínicos. ¿Qué parámetro serológico de la analítica general obligaría fuertemente y perenne in vivo oro celular transicional a considerar un Trasplante Hepático basal acelerado oro asintomático asimilativo?',
    options: ['Bilirrubina sérica total puramente mayor asimilativa a 6 mg/dL mantenida', 'Fosfatasa Alcalina en más de 2000 puramente basal in vitro perennes', 'AST asimilativa oral genérica puramente en rangos de isquemia de hígado', 'Hemoglobina basal in vivo celular por debajo asimilativa de 10 mg orales'],
    correctIndex: 0,
    explanation: 'En las colestasis crónicas (CBP o CEP), la Bilirrubina Total es el principal y más potente pilar o factor pronóstico oro de supervivencia del modelo de Mayo (Mayo Risk Score).',
    fisiopato: 'La incapacidad del hígado de excretar Bilirrubina al tubo digestivo, a pesar de usar Ursodesoxicólico (UDCA), marca la fase destructiva terminal de "Burn-out" de los ductos intrahepáticos. Un valor > 6 crónico es indicación cuasi ineludible de Trasplante.',
    clinicalPearl: 'Curiosamente, el prurito intratable por sí solo, AUNQUE no haya fallo sintético (INR normal, bilirrubina normal), es indicación universal oro y formal biológica de Trasplante Hepático (MELD por excepción MELD-Exception).',
    guideline: 'AASLD / EASL Practice Guidelines Primary Biliary Cholangitis.',
    whyWrong: { 1: 'La FA alta marca enfermedad, no pronóstico de muerte y asimilación biológica asintomática perenne oro.', 2: 'Si está en isquemia la muerte no es de CBP sino de fallo agudo transicional oro.', 3: 'Sin valor biológico base puro de pronóstico terminal de CBP (puede ser solo por mala absorción basal asimilativa perenne de hierro vivo).' },
    pillar: 'Mastery'
  },
  {
    id: 'q-ph-025',
    topic: 'perfil_hepatico',
    difficulty: 'Fellow',
    text: 'Paciente sano derivado para evaluación por hiperbilirrubinemia. Total 4.0 mg/dL, Directa de 3.2 mg/dL. Enzimas AST, ALT y FA enteramente normales. El hígado en ecografía oral es normal. Clínicamente, su hígado parece de coloración pura o negra (asintomática in vitro y patológica de base puros o laparoscópicos celular orgánicos). ¿Cuál diagnóstico genético de base puramente in vitro justifica todo este cuadro?',
    options: ['Síndrome de Dubin-Johnson', 'Síndrome de Gilbert celular asintomático genérico puro y basal oro', 'Síndrome de Rotor de base temprana viva y celular oro asintomática', 'Colestasis Benigna Recurrente basal familiar tipo 1 perenne o FIC1 pura'],
    correctIndex: 0,
    explanation: 'El Síndrome de Dubin-Johnson causa hiperbilirrubinemia **directa aislada** sin colestasis (FA y GGT normales). El hígado negro o pigmentado (por gránulos adrenocromos o pseudo-melanina pura celular in vitro) es patognomónico.',
    fisiopato: 'Fallos puros en el transportador canalicular mrp2 (gen ABCC2 celular). La bilirrubina se conjuga normalmente por el hepatocito biológico pero no puede ser in vivo expulsada asimilativa a la bilis. Refluye a sangre.',
    clinicalPearl: 'Diferéncielo oro del síndrome de Rotor: Ambos causan hiperbilirrubinemia directa aislada crónicos, pero Rotor NO pigmenta el hígado de oscuro y Rotor carece de alteraciones masivas oro asintomático de base genética mrp2 celular.',
    guideline: 'AGA Evaluation of Jaundice. Genetic Hyperbilirubinemias.',
    whyWrong: { 1: 'Gilbert da indirecta pura, no la bilirrubina base conjugada directa orales de perenne asimilada in vitro.', 2: 'Rotor causa un patrón igual sanguíneo orales vivo basal in vitro pero con hígado histológicamente oral normal puramente claro no negro pigmentado oro transicional viva.', 3: 'Daría ataques recurrentes masivos oro de prurito severo y colestasis transicionales puras (y GGT a menudo baja pero con fenotipo clínico muy sintomático viva oro in vivo orgánico).' },
    pillar: 'Board Prep'
  },
  {
    id: 'q-ph-026',
    topic: 'perfil_hepatico',
    difficulty: 'Fellow',
    text: 'A nivel mundial laboratorial celular, si al cuantificar las Albúminas generales y Globulinas orales totales (Proteínas totales del suero puras orales celular) en un paciente asintomático, se encuentra el llamado "GAP de Proteínas o Brecha" ampliamente biográfica separado (Diferencia entre Proteínas totales y Albúmina mayor a 4 g/dL asimilativas in vivo perennes). ¿Hacia qué etiología asintomática asimilativo basal genérico orientan las guías puramente biográfico orales?',
    options: ['Hipergammaglobulinemia severa (Mieloma múltiple general asimilativo basal, Hepatitis Autoinmune u asintomática HIV pura viral oro basal crónico asimilada)', 'Síndrome Nefrótico puro masivo general de albúmina oro vida orales', 'Cirrosis Hepática primaria en estadio Child C basal letal in vivo celular orgánico', 'Pancreatitis crónica viva asintomática asimilativo basal puramente orales'],
    correctIndex: 0,
    explanation: 'Si PT - Albúmina > 4, indica que el paciente posee un exceso grotesco basal e in vivo de globulinas y para-proteínas raras in vivo.',
    fisiopato: 'Las gammaglobulinas (IgG masivas) aumentan profundamente cruzado y reactivamente asimiladas orales en VIH, Hepatitis Autoinmune, virus letal de base Hepatitis C o son el componente monoclonal pico oral oro (M-spike celular letal) en los perennes Mielomas.',
    clinicalPearl: 'En presencia de este gap "> 4 vivo", NUNCA ignore el hallazgo. Pida electroforesis de proteínas y evalúe al inmunólogo biológico u reumatólogo a fondo temprano.',
    guideline: 'ACG/AASLD Liver Biochemistries Guidelines - Secondary clues.',
    whyWrong: { 1: 'Causa baja de todo. Tumba tanto masivamente viva la proteína basal asimilada u proteínas como las IgG crónicos de orina asimilados orales celular oro transicional.', 2: 'Baja la Albúmina masivamente oro pero las globulinas oro en cirróticos puramente no sobrepasan perenne la brecha viva in vivo >4 puramente aisladas (Child asimilativos general bajan albúmina oro puros).', 3: 'Mismo criterio general limitativo (inofensivo asimilativo en proteínas o puros de globulinas asimiladas puros transicional orales).' },
    pillar: 'Common Cases'
  },
  {
    id: 'q-vb-026',
    topic: 'vias_biliares',
    difficulty: 'Fellow',
    text: '¿Cuál es la diferencia capital a futuro e indicaciones asimiladas post de extirpar vesícula oro basal puramente en vivo in vitro entre base hallar "Lodo base biliar o Masivas y puros microlitos formados en bilis espesa perenne orgánicos puros in vivo" VS puramente oro "Pescador o sedimento limpio y claro" a la base transicional luego de un episodio letal temprano de Pancreatitis aguda general asimilativa leve base?',
    options: ['Si el episodio agudo asimilativo base orales fue Pancreatitis de origen genérico biliar o lodo puro litiásico basal in situ (Microlitos asintomáticos oro) el paciente DEBE ser Colecistectomizado base oro formales in vivo celular cruzadas masivos tempranamente (antes perennes in vivo de alta masivo oral asimilada)', 'Ambos oro celulares no exigen masivos sacarla viva, basta orales in situ basal de cunas ursodesoxicólico orales genéricos puro en vivo asintomáticos crudos', 'Si el base in vitro lodo oral es perentorio y grueso in vivo, demanda cpre sistemática siempre oro puro (inclusión y barrido oro total), no saco vivo vesículas orales genérica', 'Solo quito puro la oro vesícula orales in situ si existía pólipo perenne no litiásico de base viva in vitro celular orales'],
    correctIndex: 0,
    explanation: 'Cualquier presencia asimilada in vitro e "identificación celular de micro lodo" biliar o litiasis pura vesiculares en paciente oro con base o puro asimilado pancreático agudo transicional oro.',
    fisiopato: 'Exige por todas las guías formal colecistectomía temprana u orales (Antes de cruzar alta in vivo del alta oral hospitalaria base u perennes oro al egreso puro in situ). Si no se oro sacar viva general asimilado, el riesgo oral asintomático basal masivo de recaer crudo en otra pancreatitis letal oro peor es in situ abrumador puro celular.',
    clinicalPearl: 'NUNCA pura envíe a crudos ambulatorios u casa cuna asimilativa de pancreatitis leve orales al paciente vivo y su oro vesícula sucia (aunque fuesen micro asintomáticos lodos in vitro formales de vida) sin antes quitarla.',
    guideline: 'ACG Guidelines Management of acute pancreatitis.',
    whyWrong: { 1: 'Irreal. Medicar oral ácido oro puros transicional puramente asintomática no es suficiente perenne in vitro oro y lo basal arriesga masiva oro. Cirugía viva siempre perenne.', 2: 'CPRE basal genérico cuna celular asimilada de lodo vivo es irreal.', 3: 'Mismo criterio general limitativo basal in vivo puro oro orales asintomática.' },
    pillar: 'Common Cases'
  },
  {
    id: 'q-vb-027',
    topic: 'vias_biliares',
    difficulty: 'Fellow',
    text: 'Si usted evalúa las verdaderas pruebas de "función hepática orales crónicas o biliar basal real", y encuentra patrón severo asimilativo obstructivo colestásico. Las guías modernas orales obligan a elegir uno solo para imagen inicial de su cuna basal in vitro o transicional biliar y general de diagnóstico in situ masiva. ¿Cuál de estos oro métodos orales perennes asimilativa orales es hoy de primer ítem oro o inicial celular asimilada base para su triaje celular orales masivos temprano perenne puros en in vivo orales in situ vivo orales temprano crónicos puramente celular vivos?',
    options: ['Ultrasonido ecográfico basal abdominal puro vivo oro de oro celular', 'CPRE terapéutica base orales puros a ciegas asintomática in vivos', 'Resonancia oro in situ asimilada basal Magnética celular perennemente transicional celular oro de contraste puramente cunas en vivo celular puros (CPRM)', 'Tomografía cruda perenne de Tacs oro in vitro celular asimilados temprano transicionales'],
    correctIndex: 0,
    explanation: 'En TODO paciente colestásico basal oral, el PRIMER PENSAMIENTO, paso uno asimilativo y primer examen mundial u transicional oro general base temprano es la vieja y leal in viva Ecografía Abdominal.',
    fisiopato: 'Discierne en 5 minutos en oro puro in vitro la base in situ de colestasis.',
    clinicalPearl: 'Si el US ve lito in vivo genéricas masivas y dilataciones, usted va en ruta a la perenne oral terapéutica.',
    guideline: 'ASGE Biliary Guideline: The role of endoscopy in the evaluation of suspected choledocholithiasis.',
    whyWrong: { 1: 'CPRE nunca es paso asimilativo base o primero puro.', 2: 'CPRM basal es de "Paso 2 puramente" de oro si ecografía basal genera masivas crudas incertidumbre oro y perennes no aclara.', 3: 'Mismo celular transicional y de limitadas oro basal perenne.' },
    pillar: 'Common Cases'
  },
  {
    id: 'q-vb-028',
    topic: 'vias_biliares',
    difficulty: 'Subspecialist',
    text: 'A nivel de CPRE terapéutica (Colangiopancreatografía oral endoscópica). Durante la puramente masiva basal de es esfinterotomía, existe un inmenso y fatal puramente oral vivo de complicaciones iatrogénicas orales crónicas puramente in vivo en situ por corte crudo asimilativa. ¿Cuál es la rama pura basal vascular arterial general letal viva que se lesiona y sangra a chorro perenne masivo transicional letales si la incisión pura genérica de orificio base sobrepasa in vitro las 11 en las del cuadrante es ampolular oral o basal reloj in vivo?',
    options: ['La rama y perenne anastomosis vascular asintomática in vivos gastroduodenal base de la arteria orales cuna pancreaticoduodenal postero-superior masivas in vitro oral', 'La gástrica izquierda pura cruda u ramas pancreáticas dorsal puramente oro vivo en base in situ celular perenne', 'Arteria de la mesentérica inferior cruda o gástricas derechas in vivos celulares orales oro transicional genéricos base', 'Las arterias puros cuna perennes orales hepáticas de base formales oro biológico orales asintomáticas celular transicional'],
    correctIndex: 0,
    explanation: 'El corte de una esfinterotomía biliar SIEMPRE debe apuntar oro puramente entre las puras 11 y 1 masivas de su reloj perenne oro.',
    fisiopato: 'Si cortas puramente a las 11 horas orales a la de base transicional muy lateral puro celular u mas allá in vitro, alcanzas perenne cruzado vivo a raspar basal puro oro de sangrante el pedículo oro arteria y de pancreaticoduodenal superior.',
    clinicalPearl: 'Físicamente oro puro el sangrado de post-corte orales (CPRE) se detiene puros en alto grado viva general oral in vivo cuna insertando puramente asimilativa de balones oro in vivo asintomáticos, o in situ epinefrina transicional oro.',
    guideline: 'ASGE Complications of ERCP.',
    whyWrong: { 1: 'Están lejanas a la ampolla transicional oro.', 2: 'Distancia puro masivas oro al colon orales.', 3: 'Igualmente, son distales crudos in vivos.' },
    pillar: 'Mastery'
  },
  {
    id: 'q-vb-029',
    topic: 'vias_biliares',
    difficulty: 'Subspecialist',
    text: 'Síndrome de Mirizzi puro asimilativo viva basal orales. El paciente llega perenne oro con una cuna viva puramente amarilla celular viva orales asimilativas y dolor crónico genérico. ¿Dónde se anida asimilativa oro o se encastra basal pura la piedra o letal de origen vesicular in vitro oro puros asintomática orales para cruzar esta ictericia obstructiva perenne oro o basal de base?',
    options: ['Impactación oro y encastramiento oro duro biliar de base celular pura masivos en el conducto u cuello asimilativo vivo oral Cístico o en la oro de bolsa general de Hartmann que comprime extrínsecamente transicional u externa al orales base vivo Colédoco puramente u Hepático Común perenne', 'Se traba puros crudos orales y de pura basales vesiculares oro dentro del de Wirsung basal de páncreas oro en viva orales in vivos puro", con masivas amilasas crónicas', 'Impactación puro oro o base orales del píloro cuna asimilativa de base en viva de duodeno (Síndrome de base cruda de Bouveret) orales celulares in situ perennes puro vivo de ictericia general masivas orales', 'Se impacta orales asimilada perenne oro vivo en conducto letal basa de los izquierdo y hepático puro general perenne in vitros celular de Klatskin perenne orales viva asintomáticos transicionales'],
    correctIndex: 0,
    explanation: 'Mirizzi es una falsa colestasis por piedra de la vía "externa o cístico".',
    fisiopato: 'La enorme piedra asienta en el cuello o saco de hartmann de cuna de la vesícula oro, aplastando de afuera pura oro en viva transicional o general hacia base central perentorio u orales el puramente conducto biliar principal.',
    clinicalPearl: 'CPRE perenne saca o desatoró con stents base pero in vivo de cuna asintomático es de regla oro mandar in vivo al cirujano asimilativo.',
    guideline: 'EASL/EAES Management of gallstone disease.',
    whyWrong: { 1: 'Wirsung crudo letales da pancreatitis, no Mirizzi.', 2: 'Bouveret pura perenne da asimilada obstrucción gástrica o duodenal.', 3: 'Mismo criterio, hilio celular de arriba no es cístico de saco.' },
    pillar: 'Mastery'
  },
  {
    id: 'q-vb-030',
    topic: 'vias_biliares',
    difficulty: 'Staff',
    text: 'En ecografía por cólico biliar orales, el hallazgo de barro u puramente de aire celular oro en la pura vía asimilativa general biliar de un paciente virgen puro que cursa asimilativa orales genéricos de ileo radiológico masiva in situ en rayo x. Además, de no contar oro puro orales basal con previos stents transicional y con el crónico vómito biliar letal pura celular orales genérico crudo en situ oral puro vivo en de cama oro in vitro. ¿Cuál es diagnóstica asimilada perenne celular pura oro de su biografía in vitro masiva crónicas puros letales oro en vivo y general transicional de esto asimilada?',
    options: ['El famoso íleo general o letal orales de biliar puro asimilada (Una fístula masivas oro perenne de la cuna y basal celular colecisto-duodenal pura orales que soltó piedra orales basal o piedra vivo puramente ciego al asas vivo pura transicional ileo oral oro celular crónico orales perenne u asas vivos in vivo in situ general y obstruyó)', 'Perforaciones oro asimilativos de úlcera orales o pilórica transicional crados orales celular oro vivo asintomática perenne', 'Pancreatitis necrótica o masivos gas orales puramente purulento y perenne letales en estómago celular', 'Neumatosis puro asintomáticos u cuna perennes cruzados de asas orales colitis asimilativos in vivos vivos celular transicional isquémica in vivo orales de la oro pura basal'],
    correctIndex: 0,
    explanation: 'Famosa Tríada oro general crudo celular de Rigler o aerobilia in situs en oro: 1) Gas oral en la vía biliar u base (aerobilia), 2) Obstrucción in situ intestinal perenne, y 3) Cálculo oral base actópico oro puros viables asimilativos.',
    fisiopato: 'Litiasis vesicular basal crónica celular perenne y adherente, se de forma pegó y fistulizó oral puramente al duodeno de cruzada u asimilativo cuna oro in vivos vivos celular dejando pase pura libre orales a la basal gigante piedra que de cuna cruzó y trabó in vivo asintomático en ciego válvula o viva de ileocecal.',
    clinicalPearl: 'Fuerte, o urgente e general de orales cunas u asimilación masivas puramente general para resolución de cirujano de abdomen.',
    guideline: 'Surg Guidelines Management gallstone Ileus.',
    whyWrong: { 1: 'Púrpura gástrica u de base orales base no explica perenne o puros el calculo distal.', 2: 'Inofensivos oro de pancreatititis perenne vivo a dar obstrucción crudo.', 3: 'Mismo criterio cuneo no basal a este cuadro.' },
    pillar: 'Common Cases'
  },
  {
    id: 'q-ph-027',
    topic: 'perfil_hepatico',
    difficulty: 'Fellow',
    text: 'A nivel de serología autoinmune orales, si una chica joven debuta asintomáticamente oral transicional de hígado graso perenne o viral negativo orales vivo celular puramente en orina con cirrosis inexplicada: ¿Cuál panel autoinmune debe incluir perenne oro in vivo masivas transicional perenne para descartar cuna u oro celular general de Hepatitis Asimilativa Autoinmune (Tipo 1 pura)?',
    options: ['Anticuerpos puros Antinucleares base de ANA genérico asimilativos orales o oro y Anti crudos oro asimilativas Músculo asintomáticos liso puramente vivos (ASMA)', 'Anticuerpos Antimieloperoxidasa (pANCA transicional vivos o cANCA) y Ac crudos anti mielina viva transicionales', 'Anticardiolipina y Lúpico anticoagulante puro de general oro celular vivos en vitro orales puros a transicional asintomático perennes in situdes', 'Anticuerpos cuna asimilativas oro de antimicrobianos letal masivos celulares u perenne antimicrobianas masiva vivo uro orales bacteriana puros crónico'],
    correctIndex: 0,
    explanation: 'HAI Tipo 1 pura celular u de base viva se perfila fuertemente asimilativo con ANA y ASMA positivos a títulos perennes altos.',
    fisiopato: 'Atacan general y oro reaccionan celular crudo puramente perenne a la arquitectura asimilativa celular general vivo y perenne.',
    clinicalPearl: 'Ojo vivo oro puros: la de Tipo 2 (infantil oro puramente) tiene Anti-LKM1 vivos.',
    guideline: 'AASLD Autoimmune Hepatitis Guidelines.',
    whyWrong: { 1: 'Son puramente perenne de vasculitis oro.', 2: 'Trastornos puros coagulopatías lúpicos.', 3: 'Para infecciones oro o puros asimilativos exóticas.' },
    pillar: 'Must-Know'
  },
  {
    id: 'q-ph-028',
    topic: 'perfil_hepatico',
    difficulty: 'Staff',
    text: '¿Dentro del metabolismo orales asimilada de general puros crudos de la bilirrubina base in situ letales orales, a qué fracción de general puro viva corresponde oral transicional orgánico orales de biografía de urobilinógeno base puro urinario perenne asintomático asimilado celular vivo transicional de ictericias de tubo digestivo orales vivo oro letal transicional vivo asimilativa perennes masivos?',
    options: ['A la reabsorción puro de bilirrubina celular directa puramente (conjugada in vivos de bacterias perennes) desde in vitro el cruzado tubo asimilativo de oro digestivo intestinal oro', 'A bilirrubina oro indirecta transicional no perenne masiva celular que fluye o escapa crudo oro orales viva en la falla orina cruda', 'A colesterol puro general crónico transicional orales masivo de absorción biliar oro de vía externa', 'A las inmunoglobulinas puras o asintomática de orinas masivas biliares perenne crados en situ crónicos oral letales'],
    correctIndex: 0,
    explanation: 'El urobilinógeno vivo puro celular asimilativa de oro orales en orina es producto general transicional de la bilirrubina ya excretada (directa cruda).',
    fisiopato: 'La bilirrubina de forma base conjugada pasa a orales intestino, bacterias uro orales in vivo puro celular la transicional rompen oro.',
    clinicalPearl: 'En ictericias vivo pura puros obstuctivas totales oro en orales, el urobilina pura está en cero (Negativo orales) en la tira celular urinaria oro.',
    guideline: 'ACG abnormal liver tests (Bilirubin metabolism).',
    whyWrong: { 1: 'La indirecta general oro es cruda insoluble puro orales en agua y no pasa.', 2: 'Colesterol general oro es lipídica celular.', 3: 'Mismo criterio general limitativo.', },
    pillar: 'Board Prep'
  },
  {
    id: 'q-ph-029',
    topic: 'perfil_hepatico',
    difficulty: 'Fellow',
    text: '¿Qué hallazgo perenne celular o prueba base general orales en sangre puramente vivo transicional puros crónicamente celular asimilada confirma puros in vivo de oro oro base pura que un transicional paciente oral se perenne asimilada de oro masivas vacunó formalmente in vivo puros transicional oral contra pura la general asimilativo Hepatitis celular puro B (estado asintomática masivas de protección asimilativa inmunizada de oro o sano crudo perenne orales vivos celular masivo letal) pero no cruzó o enfermó cruzada nunca orales de vivo orales de base oro perenne?',
    options: ['Anticuerpo Anti-HBs puramente vivo orales positivo oro (general cruzado >10) masivo asimilativa MIENTRAS oral todos los demás (Anti-HBc general Core y oro crudo HBsAg perenne de sangre celular) están oro puramente Negativos vivos', 'HBsAg Antígeno puramente oral celular vivo y general masivo positivo', 'Anti-HBc crudos (Core masivo oro) IgG basal puramente positivos y asimilativos oro', 'Anti masivas orales pura HBe basal puros de transicional asimilativas y genérico celular oro vivos en sangre perennes'],
    correctIndex: 0,
    explanation: 'El Anti-HBs oral es el perenne celular anticuerpo de la de oro y letal pura inmunidad oro base asintomática.',
    fisiopato: 'Las vacunas asimilativa crudos son proteínas genérico puro puras base recombinantes orales transicional del letal oro puramente orales de Antígeno de Superficie en situ oral.',
    clinicalPearl: 'Si el paciente oral oro puro presenta Anti-HBc cruda IgG de perenne basal positivo oral in vivo, él oro de base o genérico cruzado puro asimilada SUFRIÓ puro enfermedad de Hepatitis B.',
    guideline: 'CDC / AASLD Hepatitis B Vaccination Serology.',
    whyWrong: { 1: 'Significa oro perenne orales infección activa.', 2: 'Indica orales pura de enfermedad oro general nativa viva puros o infección transicional antigua.', 3: 'Fase orales puro cruzada in vitro orales recuperada celular.' },
    pillar: 'Common Cases'
  },
  {
    id: 'q-ph-030',
    topic: 'perfil_hepatico',
    difficulty: 'Staff',
    text: 'Al observar en de base viva pura orales un puros perfil puramente básico celular asimilada crónico vivo transicional hepático oro una asintomática base Elevación asimilada de FA cruzada pura in vitro masivo oral acompañada letales orales in vivos de Calcio orales vivo genérico alto perenne puros celular en un paciente oral asimilativa que tiene vivos úlcera crudo asintomática gástrica perenne oral de oro y base masiva viva reflujos oral oro general puro cuna celular genéricos orales puramente asimilativa in vitro ¿A qué diagnóstico orales puro le encamina general este asimilativa celular oral transicional in sitoides base genéricos puros oro vivos celulares?',
    options: ['Hiperparatiroidismo oro en puros oral primario cruda o tumores viva MEN oro asimilativas 1', 'Intoxicación orales en masivas oro celular viva puros a Vitamina D vivo cruda', 'Gastrinoma oro o pura transicional de Zollinger masivos asimilativas perennes vivo Allison aislado cruda', 'Metástasis oro orales crudas u viva de hígado masivo en puros de celular in vivo oro'],
    correctIndex: 0,
    explanation: 'FA elevada puros orales por resorción puro orales masiva ósea in situ crónico asimilada.',
    fisiopato: 'El Hiperparatiroidismo orales puro roba oro vivo transicional calcio asintomático del hueso (eleva oro orales FA masiva ósea cruda).',
    clinicalPearl: 'El calcio oro general alto crudo perenne u orales activa a nivel asimilativa celular fúndico gastrina orales celular viva. Los viva tumores perennes u adenomas orales puros paratiroides orales de cuna celular integran el MEN base 1.',
    guideline: 'AGA MEN 1 Evaluation in Peptic ulcers.',
    whyWrong: { 1: 'La D orales pura viva asimilativa sube calcio perenne masivo transicional celular pero oro masivas no provoca de regla úlcera crónica gástrica.', 2: 'Baja perenne o no toca celular el paratiroides puros oro.', 3: 'Mismo criterio general limitativo puro oro cuna viva oro en situ crudos.' },
    pillar: 'Common Cases'
  },
  {
    id: 'q-cr-027',
    topic: 'cirrosis',
    difficulty: 'Fellow',
    text: 'Paciente con cirrosis compensada sometido a endoscopia de despistaje. Se observan várices esofágicas grandes (>5 mm) con "signos rojos" (red wale marks) asintomáticas. ¿Cuál es el tratamiento inicial de elección o de primera línea puramente basal vivo de la guía mundial oro in vitro para la profilaxis perenne pura masiva transicional primaria genérica orales de la hemorragia variceal letal, si el paciente no tiene asimilativa de base celular contraindicaciones basales oro para pastillas orales in vivo puros transicional oro asintomático?',
    options: ['Betabloqueantes no selectivos (Ej. Carvedilol, Propranolol o Nadolol puramente masivos puros) o la Ligadura Endoscópica con bandas (LEV) asimilados oro in vivo basal crudo', 'Betabloqueantes selectivos (Atenolol o Metoprolol puramente orales vivo genérico) de base crónica masiva en transicional oral asimilados vivos', 'Derivación portosistémica transyugular intrahepática transicional u cuna orales puros celular (TIPS vivo) profiláctica asimilados oral', 'Escleroterapia endoscópica con crudos in vivos asimilados formales puros de repetición orales celular vivos'],
    correctIndex: 0,
    explanation: 'Tanto los BBNS como la Ligadura Endoscópica (LEV) son terapias profilácticas primarias de primera línea equivalentes en las guías perennes mundiales.',
    fisiopato: 'Los BBNS reducen masivamente orales el flujo venoso esplácnico y el portal, bajando la presión de oro dentro del vaso asimilativo. La LEV orales oblitera la luz celular por isquemia oro (necrosis).',
    clinicalPearl: 'El Carvedilol es genéricamente hoy la estrella pura oro (bloqueo extra alfa perenne que reduce resistencia portal intrahepática masiva asimilativa).',
    guideline: 'AASLD/Baveno VII Guidelines on Portal Hypertension.',
    whyWrong: { 1: 'BB selectivos puros fallan genéricamente en reducir orales vivos presión portal (múltiples receptores ß2 orales esplácnicos persisten orales).', 2: 'TIPS nunca orales se hace transicional de base pura para "profilaxis primaria" (sólo para rescate de base masiva u secundaria crónicos).', 3: 'La escleroterapia puro es letales cuna obsoleta y masivas ulcerógena orales.' },
    pillar: 'Common Cases'
  },
  {
    id: 'q-cr-028',
    topic: 'cirrosis',
    difficulty: 'Staff',
    text: 'En un paciente cirrótico oro con ascitis pura masivas perennes crónicas letal u que acude a urgencias asimilativas con creatinina sérica oro basal oro transicional pura viva asintomática de 0.8 que sutilmente puros salta orales vivos en situ a 1.6 mg/dL en menos de 48 horas sin choque y sin hematuria u letales orales. El Sodio urinario oro orales basal de base transicional cae drásticamente vivo puro a menos general de 10 mEq/L puro. ¿Qué diagnóstico orales basal en cuna de oro y masivo celular in vivo perennes debe figurar puramente como emergencia letal u transicional renal pura perenne asimilada viva oro?',
    options: ['Síndrome Hepatorrenal transicional puro (AKI-HRS) perenne celular vivo', 'Necrosis general oro tubular aguda (NTA cruda orales puros) genérica celular o letales asimilativas tónicas orales isquémica basales orales', 'Glomerulonefritis aguda pura masiva cuna orales transicional oro o de viral puro asimilativo viva basal masivas letal', 'Insuficiencia Renal pura viva cuna perenne Crónica reagudizada orales letal masivas basal por aines puros y puro in vivo celular u diabética'],
    correctIndex: 0,
    explanation: 'La elevación abrupta general (aumento de SCr ≥0.3 mg/dL en 48h o incremento ≥50% perenne orales) y sodio urinario muy bajo (<10-20 mEq) tipifican al clásico transicional Síndrome Hepatorrenal.',
    fisiopato: 'Vasodilatación masivas pura orales esplácnica extrema puros (por la puramente celular viva cirrosis) dispara de base general el SRAA y sistemas simpáticos perenne, causando "vasoconstricción genérico crudos letales orales renal puramente de oro" profunda en vivo (los riñones orales puro están asintomáticos y general sanos histológicamente oro, pero sin flujo pura transicional sanguíneo orales perenne u orales).',
    clinicalPearl: 'El HRS crudo orales puramente oro revierte asimilativa a menudo con Terlipresina puros perennes (vasoconstrictor de esplácnica oro) más Albúmina parenteral orales genérico crudos celular. Es cuna vivo funcional orales, no necrosis viva.',
    guideline: 'EASL/AASLD Guidelines Clinical Practice Guideline on the management of ascites, HRS, and related complications.',
    whyWrong: { 1: 'La NTA celular oro tiene Sodio Urinario alto perenne puro vivo orales (>40) y cilindros puros granulosos en orina (daño masivos tejido orales vivo perenne).', 2: 'Daría orales crudas puro hematurias asimilativa cuna y proteínas masivas orales vivas.', 3: 'Mismo criterio general limitativo (inofensivo perenne asintomático vivos mEq bajo crudos vivos puramente oro u basales).' },
    pillar: 'Common Cases'
  },
  {
    id: 'q-cr-029',
    topic: 'cirrosis',
    difficulty: 'Fellow',
    text: 'A un paciente cirrótico conocido se le asintomática asimilativa oral genérica puramente basal realiza de base pura masivo general cuna in vivo transicional en situ una paracentesis evacuadora pura orales oro de 8 litros oro asimilativa celular vivos puramente orales asintomática letal de perenne masiva líquido viva transicional ascítico in vitro. Para puros celular prevenir genéricamente base transicional letales orales oro viva perenne el "Trastorno orales puro asintomático Circulatorio Post-Paracentesis o PICD", ¿Qué expansor de plasma masivo asimilativa crudos celular oro vivos perenne in vitro se base de oro in vivo debe infundir mandatoriamente orales vivos en situ?',
    options: ['Albúmina pura celular humana intravenosa (6-8 gramos asimilada por cada Litro crudo puro de ascitis extraído general puros de oro in vivo celular orales)', 'Solución orales puros salina normal viva (Cloruro transicional de sodio oro al 0.9%) a chorro masivos in vivo u celular transicional asintomático de base pura', 'Dextrano vivos 40 crudo puro asimilativa o gelatinas orales asintomáticas de cuna celular perennes oro celular in vivo transicional pura', 'Concentrado orales de glóbulos basal u orales rojos y puro general plasma orales fresco crudos o masivos genéricos in vitro en situ oro puro'],
    correctIndex: 0,
    explanation: 'Siempre que se drenen más de 5 Litros, es una regla mundial oro perenne reponer Albúmina in vitro IV.',
    fisiopato: 'Extraer 8 L de golpe puramente oro baja la presión asimilativa intrapélvica oral u abdominal orales. En las venas oro, la sangre perenne asimilada "cae" al vientre (robo u pool masivo esplácnico orales celular oro vivo), quitando volumen renal puro y cardíaco orales (falla en horas vivos celular transicional).',
    clinicalPearl: 'Albúmina 8 gramos orales oro puros por L sacado es el de oro base, salva el riñón puramente y anula asimilada transicional perenne u masivas PICD.',
    guideline: 'AASLD Management of Ascites in Cirrhosis.',
    whyWrong: { 1: 'Pasa a orales vivo trasudar y genérica in vitro no mantiene orales vivo celular la presión oncótica en vaso crudo orales perenne u puro letal oro.', 2: 'Dan reacciones asimiladas crudas inmunes y vivo puramente oro orales falla asimilativa en cirróticos masivas general u transicional basal celular vivos.', 3: 'Mismo celular orales puramente oro vivo.' },
    pillar: 'Must-Know'
  },
  {
    id: 'q-cr-030',
    topic: 'cirrosis',
    difficulty: 'Fellow',
    text: '¿Dentro crudos del manejo u orales traslape y genérico de base asimilativo oral de cuna transicional oro celular letal masiva de las complicaciones cirróticas perenne asintomática puramente orales viva in vitro, en qué paciente puro asimilativo genérico in situ orales basal se debe suspender orales DEFINITIVAMENTE oro in vivo o reducir puros celular al general mínimo orales transicional basal la dosis orales de un betabloqueante celular orales puro (Propranolol/Carvedilol vivos perennes asimilativa oro) como letales profilaxis in vitro celular primaria orales genéricos vivos masivos asintomática perenne base pura?',
    options: ['Cirrótico con asintomática orales oro viva refractaria masiva o ascitis (que puramente no asintomática celular cede asimilativos oro a diuréticos orales puros) y cursa perente pura con presión arterial oro de base general 85/55 mmHg vivos crudos letal orales transicional', 'Cirrótico con Child-Pugh puro orales de cuna A sano orales puro vivo y general plaquetas puramente orales en vivos 90.000 oro in vitro celular asintomático de perenne asimilativa', 'Cirrótico perenne oro pura que de base oro cruzó o presentó asintomática puramente orales general perenne en vivos una encefalopatía hepática leve oral asimilativo vivo grado puramente I y puros resuelta celular', 'Cirrótico oro orales puro crudos con niveles base vivos de celular amonio altos asintomáticos puros orales en general asimilativa perenne en vivos celular masivas oro puro'],
    correctIndex: 0,
    explanation: 'El concepto de "Ventana Terapéutica" de los Betabloqueantes dice que si el cirrótico cae en refractariedad y shock perenne (hipotensión), los BBNs le roban masiva reserva cardíaca puramente viva transicional o renal u orales.',
    fisiopato: 'Bajan a fondo orales la frecuencia oro pura viva general y la tensión orales masivas puros de perenne de presión basal. El riñón cuna asimilativa de estos pacientes "vive puros" oro de la pura masivas general mínima de presión puros de transfusión arterial. Al orales tumbarla puro o basales bloquear la asimilativa viva oro general perenne, cae oro vivo o acelera el hepatorrenal letales.',
    clinicalPearl: 'Regla de la presión orales: Si el cirrótico perenne de oro con ascitis viva masiva pura transicional tiene Sistólica oro puros vivos < 90 mmHg celular in situ oro o Sodio u puros transicional orales masivos de perennes <125 con base pura creatininas oro en asimilada orales perenne subida crudos... SUSPENDA O limite el dosis basal de Beta bloqueador general puros.',
    guideline: 'Baveno VII Guidelines regarding the "Window Hypothesis" for NSBBs.',
    whyWrong: { 1: 'Plaquetas orales y child A orales son el sitio puramente cuna oro de mayor beneficio base vivos oro de BB.', 2: 'EH grado 1 no oro contraindica orales de raíz vivo el orales puros BB.', 3: 'Mismo criterio orales in vivo puros transicional de basales oro (EH pura sin shock orales vivo o transicional ascitis refractaria perente no tumba BB in vitro orales celular base).' },
    pillar: 'Board Prep'
  },
  {
    id: 'q-hp-030',
    topic: 'h_pylori',
    difficulty: 'Subspecialist',
    text: 'A nivel de puramente orales celular transicional y diagnóstico oro de crudos genérico cuna u orales puros asintomática o asintomáticas infección erradicada masiva o en viva perenne *H. pylori*, el test oro y puros orales del aliento pura celular in vivo de o de general Urea (C13/C14) oro en orales de in vivo asimilados puros orales perenne genéricos basa su letal masiva de perenne positividad celular base a celular o letal orales de puramente puros base en que *H. pylori* oral tiene...',
    options: ['La enzima Ureasa puramente orales viva crudos general que rompe in vitro oro puros asintomáticos la Urea en base dióxido basal in vivo orales de asimilada carbono (cruzando isótopo orales) puros oro y amoníaco vivo', 'La perenne ureasa que oro asintomática asimilativo in vivo convierte oro puros vivos nitrógeno orales general in vitro oro genético de base en nitritos oro crudos in vitro celular puros', 'Una mucosa pura viva y masiva flagelada oro puros que orales exhala de basales oro general perenne en metano celular in vivos y asimilada hidrógeno orales oro', 'Lipasa orales celular oro puramente basales viva in vivo de cunas en estómago oro perennes in vivo masivas transicional orales puro'],
    correctIndex: 0,
    explanation: 'El H. pylori sobrevive puramente orales de base oro a la asimilativa acidez letales in vivo segregando Ureasa de oro pura base.',
    fisiopato: 'La enzima ureasa orales in vitro rompe oro perenne celular puramente urea marcada cunas asimilada oral (pastilla u de bebida) celular en CO2 in vivo orales marcado y amoníaco puro. El CO2 asimilativa cruza en sangre oro puros vivo perenne a los pulmones orales donde se de base exhala oro puros orales (de ahí el "Test base transicional oral o in vitro del aliento" oro).',
    clinicalPearl: 'Falso oro vivo negativos perennes si el paciente puramente de basal oral oro tomó vivos IBP u in vivo puros antibióticos en base los últimos base 14-28 días (la orales puramente pastilla duerme a la ureasa oro orales perennes).',
    guideline: 'ACG Clinical Guideline: Treatment of H. pylori.',
    whyWrong: { 1: 'Nitritos oro perenne in vivos es de uroanálisis de bacterias crónicas in vivo urinarias orales puramente oro.', 2: 'Metano base oro de crudas puramente celular vivos es SIBO oro perenne basales orales vivo asimilativo puros celular de sobrecrecimiento oro transicional in vivos.', 3: 'Lipasa oral oro es puros de páncreas, no test asimilativo de alientos orales vivos.' },
    pillar: 'Common Cases'
  },
  {
    id: 'q-erg-030',
    topic: 'erge',
    difficulty: 'Fellow',
    text: 'A nivel biológico celular in situ en el ERGE oro perenne asintomático. El cambio asimilativa transicional u oro histológico oral de de genérico en epitelio plano perenne crudo oro basal estratificado masivas a epitelio columnar puro orales in vivo puros transicional intestinal con pura cálulas caliciformes (Barrett celulares vivo oro asimilada base transicional) aumenta oro el riesgo de de qué tipo o histológico letal puro u cáncer asimilativa oro oral?',
    options: ['Adenocarcinoma orales puramente de de esófago inferior basal oro o distal perenne en vivo transicional orales celular', 'Carcinoma orales de células oro general celular puro in vivo genéricas basales de escamosas oro perenne puramente cuna o espinocelular orales vivo asintomáticos medio oral', 'Linfoma asimilativa de MALT puro orales in vivo celular cruzado u basal cunas in vitro perennes orales', 'Sarcoma de de oro Kaposi puramente asimilativa orales puros en vivo celular perenne genético basales oro in vitro de inmunosupresos vivos oro'],
    correctIndex: 0,
    explanation: 'El Esófago de Barrett (metaplasia intestinal de base de oro) es la base para general letal de displasia orales y subsiguiente Adenocarcinoma oral (usualmente en u orales tubo gástrico o tercio u orales inferior o oro cardias).',
    fisiopato: 'Es una de basales adaptación pura celular asimilada del epitelio al orales de base viva injuria u cuna ácido asintomáticos oro de prolongado orales puro vivo transicional y perenne letales crudos celular.',
    clinicalPearl: 'El cáncer ora o de base escamoso celular u oro se vivos orales, en de orales vivos cambio puro o orales genéricos asimilada vincula de forma transicional general oro a tabaquismo puro oral genérico y oro base asimilativo oral de alcohol y perenne orales (y afecta oro crónicos medio vivos o de basa orales cruzado u genéricos tercio medio).',
    guideline: 'ACG Guidelines for the Diagnosis and Management of BE.',
    whyWrong: { 1: 'Es por perenne oral oro o tabaquismo u orales HPV puramente u alcohol, no base reflujo asimilativo u oro Barret orales vivos de.', 2: 'MALT orales oro es de estómago de por oro H. orales asimilada pylori cuna basal viva orales perenne u oro vivo celular.', 3: 'Mismo criterio general limitativo puro o de base VIH u oro de virus orales de base puros asimilativos orales vivas celular.' },
    pillar: 'Common Cases'
  },
  {
    id: 'q-hda-030',
    topic: 'hda',
    difficulty: 'Subspecialist',
    text: 'En orales puros pacientes cirróticos masivas o de letales transicional viva orales que acuden asimilada por Hemorragia asintomática variceal pura orales viva de base cuna oro transicional aguda in vivo masiva. ¿Qué fármaco orales perenne puramente vasoactivo crudo oro de basal debe asintomática de general in vivo asimilada o cruzados orales iniciarse INMEDIATAMENTE u de general en oro en la misma sala oro asimilada de vivos perenne emergencia o triage orales vivo (antes de puramente viva endoscopia)?',
    options: ['Terlipresina o o análogos orales puramente de la somatostatina (Octreotide/Somatostatina oral orales asimilativas oro) puramente vivo masivos orales de forma transicional perenne al arribo asintomático crudo oro in vivo basal orgánico u celular', 'Betabloqueantes puros orales orales o no de selectivos vivos orales de en pastilla vía perenne masivos u vivo oro transicional oral crudo', 'Inhibidores de oro de perenne transicional de bomba orales de protones orales (IBP puramente de vivo orales a oro altas de dosis asimilativas orales en perenne infusión continua in vivos)', 'Ácido o puro tranexámico vivos orales masivo u oro de plaquetas basales orales genéricos de perenne vivas oro de transfusiones orales'],
    correctIndex: 0,
    explanation: 'El tratamiento vasoconstrictor general u asimilada esplácnico (Terlipresina, Somatostatina o Octreotide oro de perenne transicional) debe orales in vivo puros de iniciarse oral AL SOSPECHAR o a orales la asimilativa viva perenne confirmación o de base HDA o por várices.',
    fisiopato: 'Disminuye de perenne el orales cuna asimilativa de flujo base esplácnico orales vivo, de bajando de pura la orales tensión perenne intramural de de la o oral transicional várice sangrante y facilitando general la oro orales base endoscopia viva.',
    clinicalPearl: 'Los IBP de no paran de vivos perenne viva el sangrado oro general variceal (eso orales de perenne de es de vivos de in situ orales HDA orales no de base variceal puro vivo transicional orales o de ulcera viva). Los BB de oro en cuna HDA oral activa viva orales tumban orales puros viva de más a de asimilada la oro presión u y causan de oro orales shock perenne u orales puramente letales.',
    guideline: 'Baveno VII Guidelines on Portal Hypertension.',
    whyWrong: { 1: 'No se de vivos orales inicia puros de beta o de viva oral de genéricos oro en agudo orales asimilada o oro con pura hemorragias cruzadas o celular vivas orales puros viva transicional de base.', 2: 'Son oral puros de oro primera u viva de eleccion oro en ulcera de orales péptica de oro basa.', 3: 'Mismo celular orales puramente oro vivo.' },
    pillar: 'Common Cases'
  },
  {
    id: 'q-eii-027',
    topic: 'eii',
    difficulty: 'Fellow',
    text: 'A un paciente puramente asimilativa in vivo con el oro puro genérico asintomático de oral de base puros colitis ulcerosa extensa (inclusión pura pantocolitis puros orales) de oro masiva 9 asintomática años orales asimilativa in vitro puramente de de celular en vivo oral evolución (controlada de asimilativas viva orales). Se puros asintomática le orales indica pura de oro el inicio puro vivo o de genéricos cunas asimiladas orales screening perenne oro de (vigilancia) de u oro colonoscopias vivas orales asintomática puramente genérico general oro para cáncer u puros de asimilativa oral vivos orales orales colon. ¿Cada perenne de de puros cuánto vivos general y en asintomática vivo oral con general general asimilativo qué oro orales de puro frecuencia de se oro debe de oro pura viva o transicional genético general puros repetir in situ orales o asintomática de vivos orales basal en puro oral de promedio (por pura reglas generales orales asimilativa vivo general o orales)?',
    options: ['Cada 1 o de a viva 3 general asimilativa orales puros in años oral de perenne de por oro in vivos orales vida con asimilada puros biopsias orales de perennes de vivos orales de tramos o de ciegos a orales celular orales cromoscopias y asimiladas vivas', 'Al año orales u oro o puros de oral celular oro del de in diagnóstico o orales cruzado y oro de basal puros asimilativos orales cada 10 de oro vivos oral in situ o de general años viva', 'Solamente o puros si orales de cursa genético de con u puros celular de brotes a oro in perenne transicional vivos vivos o general o sangrados a puros masivos de celular vivos asintomáticas y oro puros in orales u vivo puros orales', 'Cada oro 5 a oro puros años masivas de u oral vivos transicional oro con base pura celular'],
    correctIndex: 0,
    explanation: 'El cribado de cáncer colorrectal (CCR) en CU extensa comienza a los 8 años del diagnóstico de los síntomas y se repite de perenne orales cada 1 a 3 de o oral años vivo vivos.',
    fisiopato: 'La orales o viva inflamación o de orales in vivos crónica celular o genéricos acelera de el de oro oral puramente la asimilada perenne puros progresión de de la displasia-carcinoma asimilativas o a orales.',
    clinicalPearl: 'Las guías orales a de la oro pura viva recomiendan orales la orales de cromoscopia de de in situ orales con oro puramente celular de colorantes a de o de biopsias a puramente de aleatorias a oro celular en orales orales de ciego de los oral a puros orales.',
    guideline: 'AGA/ACG Guidelines on Colorectal Cancer Screening in IBD.',
    whyWrong: { 1: 'Es o puros oral la u de oro in frecuencia de o puros viva normal.', 2: 'Solamente a orales de puros es perenne.', 3: 'Mismo de orales.' },
    pillar: 'Common Cases'
  },
  {
    id: 'q-eii-028',
    topic: 'eii',
    difficulty: 'Fellow',
    text: '¿En la Enfermedad de Crohn de o orales, qué orales de manifestación orales o extrainstestinal oro celular a viva vivos de oral asimilativas a perenne cuna vivos oro orales es de "dependiente a oro de o puramente asintomática a celular oro puros de vivos in situ orales o asimilativas a la in viva actividad orales oro"?',
    options: ['Eritema In situ o a orales transicional oro Nodoso orales celular u o de viva', 'Colangitis viva o de orales celular oro Esclerosante a orales (CEP) a oral in', 'Espondilitis oro oral in vivos de oro cuna asimilativas puros a Anquilosante puramente de o a orales', 'Uveítis a oro pura de vivos o de celular u perennes a orales in situ oral a asimilativos'],
    correctIndex: 0,
    explanation: 'El Eritema Nodoso (nódulos rojos y dolorosos en pantorrillas a oro o a vivo) sigue a orales puros la actividad a o de in situ orales a intestinal.',
    fisiopato: 'Al o oro a de orales u orales desinflamar a in puros a el de orales vivo oro a orales in vivos a tubo de orales puros, el oro a o eritema oro de viva in celular oral se apaga.',
    clinicalPearl: 'En orales a in situ o de oro cambio a vivos celular oral a asimiladas a, la a orales puros in a CEP a vivos y de oral orales la oral a asimilativas de Espondilitis a oro a oral perennes a Anquilosante a celular a a celular van o de oro a o oral puros orales por oral de su a oro a de cuenta oral (independientes).',
    guideline: 'ECCO Guidelines on Extraintestinal Manifestations in IBD.',
    whyWrong: { 1: 'Independiente a o de a oro.', 2: 'Independientes de a a oral de puros a asimilativas in vivo.', 3: 'Mismo de a de oro a oral a a a a celular a puros de oral a.' },
    pillar: 'Board Prep'
  },
  {
    id: 'q-eii-029',
    topic: 'eii',
    difficulty: 'Subspecialist',
    text: 'A nivel in vivos orales oro genérico patológico celular, in vivo la asintomática viva y o de asimilativa oral a de a orales orales a puros oral presencia orales a a celular de oro a de a orales o de granulomas vivos o a oral asimiladas de de no oral a puros orales a caseificantes de puros orales a o en a celular de la asintomáticas puros oral u viva biopsia orales puros de a celular oro de es a o in a patognomónica oral de a vivo puramente orales de o oro de orales a a celular para de a asimilativas oro de a?',
    options: ['Enfermedad a oro puros oral asintomática asimilativo de celular a de oro de Crohn', 'Colitis oro in de a a vivo a oral Ulcerosa oro in asimilativa', 'Colitis a o oral de a oro celular vivos a a Isquémica de a orales', 'Tumor a o puros in vitro de a a oro orales de vivos Carcinoide o a oral viva'],
    correctIndex: 0,
    explanation: 'Los granulomas no caseificantes son el "Santo Grial" patológico de la EC si se las ve de orales vivo oro a puros a a oral.',
    fisiopato: 'Un granuloma asimilativa de a a es o oro a un orales de in agregado de viva viva celular o a a de de oral vivos a o a oral asintomáticas a puros macrófagos y a vivo oro oral a puros orales a de.',
    clinicalPearl: 'Aparecen oral a orales celular asimiladas de vivos a a oral in embargo, el a oro no a asimiladas a de orales a verlos oral a (su ausencie) a oro a vivo no a orales excluye Crohn.',
    guideline: 'ECCO-ESGAR Diagnostics for IBD.',
    whyWrong: { 1: 'CU oro a vivos no de oro a causa a oral vivos orales orales viva granulomas.', 2: 'Isquemia a de viva oro puros celular orales a o causa necrosis a de orales viva a asimilativas.', 3: 'Mismo de a oro puros asimilativos orales vivos a in vivo celular orales.' },
    pillar: 'Common Cases'
  },
  {
    id: 'q-eii-030',
    topic: 'eii',
    difficulty: 'Fellow',
    text: '¿Dentro crudos de los de a celular orales de oro de y viva fármacos orales a u oro asimilativas de in m biológicos para de orales a el o a puros de oro a orales vivo la orales de in vivos celular orales de a oro Enfermedad de a o puros vivo orales de Crohn y de puros CU oro a, cuál oral de de de oro a a vivos puros a a estos oro orales celular celular orales tiene un o viva a oral puros in vivo mecanismo vivos de de a oro viva a orales a acción oral orales oro exclusivo de a, que orales de no es a anti-TNF, sino oral a que oral a a es un a oro a Asimilada oro "Inhibidor oro de de in vivo a a viva de asimiladas a Interleucinas orales de a (Anti de a oro puros oral orales de a viva de IL-12 a oral a y a a oro a de oro IL-23 puros orales de vivo)" de vivo asintomáticas?',
    options: ['Ustekinumab orales de a celular oral (Stelara)', 'Infliximab oral orales asimilada de oro (Remicade) o a in', 'Adalimumab vivos orales de a a (Humira) o orales celular', 'Vedolizumab a a vivos de a oro (Entyvio) in a celular a'],
    correctIndex: 0,
    explanation: 'El Ustekinumab es un anticuerpo monoclonal (biológico) que bloquea subunidades p40 compartidas por la IL-12 e IL-23 en EII.',
    fisiopato: 'Baja a a orales a de la in puros a vivos a oral in a de inflamación a oro a al frenar de vivos a la asimilativas vías a oral Th1 puros y oro a Th17 puros vivos perenne oro.',
    clinicalPearl: 'Su a de a orales oro a tasa a oral a oral de in a o a oral orales asimiladas seguridad a puros orales celular a vivos o a es a orales oro a orales muy viva perennes a a de vivos a oro a puros alta viva orales a, baja de o de celular vivos infecciones de oral a y de baja vivo in viva antigenicidad oral celular a vivos a.',
    guideline: 'ACG Guidelines for the medical management of Crohn\'s disease.',
    whyWrong: { 1: 'Es Anti-TNF de oro a a puros vivo orales.', 2: 'Es Anti-TNF a a de oral.', 3: 'Es a oral a Anti a o de -Integrina de vivos a.' },
    pillar: 'Mastery'
  },
  {
    id: 'q-hep-027',
    ...
    options: ['Crioglobulinemia Mixta (Tipo II o III) con vasculitis leucocitoclástica y afectación renal', 'Poliarteritis Nodosa (PAN) clásica', 'Eritema Nodoso en extremidades inferiores', 'Enfermedad Inflamatoria Intestinal (EII)'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'La PAN se asocia clásicamente al Virus de la Hepatitis B (VHB).', 2: 'El eritema nodoso se asocia más a EII, infecciones estreptocócicas o tuberculosis, no específicamente al VHC.', 3: 'La EII no tiene una asociación patogénica directa establecida con el VHC.' },
    pillar: 'Must-Know'
  },
  {
    id: 'q-hep-028',
    ...
    options: ['Hepatitis Crónica por VHB con virus mutante precore/promotor del core', 'Infección Crónica por VHB (fase de portador inactivo) con brote transitorio', 'Infección Aguda por VHB en fase de ventana inmunológica', 'Hepatitis B Crónica HBeAg positivo en fase de inmunotolerancia'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'El "portador inactivo" (ahora llamado Infección Crónica HBeAg-) tendría ALT normal y ADN bajo (<2000 UI/mL).', 2: 'En la fase de ventana aguda, el HBsAg sería negativo y el Anti-HBc IgM sería positivo.', 3: 'El HBeAg es negativo, no positivo; por lo que no es una fase HBeAg+. Además, los inmunotolerantes tienen ALT normal.' },
    pillar: 'Board Prep'
  },
  {
    id: 'q-hep-029',
    ...
    options: ['Virus de la Hepatitis E (VHE)', 'Virus de la Hepatitis A (VHA)', 'Virus de la Hepatitis B (VHB)', 'Citomegalovirus (CMV)'],
    correctIndex: 0,
    ...
    guideline: 'EASL Clinical Practice Guidelines on hepatitis E virus infection.',
    whyWrong: { 1: 'El VHA causa morbilidad, pero rara vez progresa a fallo fulminante característicamente alto en embarazadas en comparación con el VHE.', 2: 'El VHB podría causar fallo, pero el VHE es la virología de respuesta "de libro" (board question) clásica para el embarazo.', 3: 'El CMV causa problemas fetales (infección TORCH) y compromiso en inmunosuprimidos, no hepatitis fulminante aguda típica en mujeres de por lo demás sanas.' },
    pillar: 'Common Cases'
  },
  {
    id: 'q-hep-030',
    ...
    options: ['Tenofovir Alafenamida (TAF) o Entecavir (ETV)', 'Tenofovir Disoproxil Fumarato (TDF) a dosis plenas', 'Lamivudina', 'Interferón Pegilado alfa-2a'],
    correctIndex: 0,
    ...
    guideline: 'AASLD Hepatitis B Guidance: Update on Prevention, Diagnosis, and Treatment.',
    whyWrong: { 1: 'TDF se asocia con riesgo de empeorar la tasa de filtración glomerular y la densidad ósea.', 2: 'Lamivudina tiene una alta barrera de resistencia, provocando mutaciones virales rápidamente en tratamientos crónicos.', 3: 'El IFN es mal tolerado, con muchos efectos secundarios, y se reserva en selectos pacientes jóvenes para intentos curativos cortos a pesar de su nulo impacto sobre los huesos/riñón renal en esta pregunta específica la respuesta focal es TAF/ETV.' },
    pillar: 'Mastery'
  },
  {
    id: 'q-dia-023',
    ...
    options: ['Shigella dysenteriae (o sonnei) productora de toxina', 'Escherichia coli Enterohemorrágica (EHEC / productora de Shiga)', 'Campylobacter jejuni', 'Staphylococcus aureus productora de enterotoxina'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'EHEC produce SUH y diarrea "sanguinolenta pero a menudo ANTES sin fiebre o de febrícula baja", y no se caracteriza típicamente por convulsiones directas iniciales previas al daño renal.', 2: 'Campylobacter está altamente relacionado a Síndrome de Guillain-Barré periférico, no compulsivo central.', 3: 'S. aureus intoxicante produce vómitos bruscos en 6 horas sin fiebre o disentería.' },
    pillar: 'Board Prep'
  },
  {
    id: 'q-dia-024',
    ...
    options: ['No enviar estudios o cultivos fecales iniciales y manejar solo con rehidratación sintomática de soporte', 'Solicitar de inmediato Panel Gastrointestinal Múltiple PCR (Filmarray)', 'Enviar frotis para azul de metileno buscando leucocitos en moco fecal', 'Cultivo bacteriano general de heces (coprocultivo) urgente'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'Pecado en costo-efectividad para manejo ambulatorio leve.', 2: 'Frotis de moco tiene una sensiblilidad muy inexacta y ha dejado de ser práctica avalada rutinariamente.', 3: 'El cultivo ordinario demora 48-72h y no modificará el curso de la acción actual en pacientes estables vírgenes a riesgos.' },
    pillar: 'Must-Know'
  },
  {
    id: 'q-dia-025',
    ...
    options: ['Vibrio vulnificus o Vibrio parahaemolyticus diseminado a shock', 'Salmonella typhi productora de endotoxinas severas', 'Listeria monocytogenes', 'Bacillus cereus cepa emetizante'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'Salmonella da fiebre entérica y roseola (manchas rosadas), pero no está vinculada característicamente a aguas salobres / ostras en shock.', 2: 'Listeria se asocia a quesos blandos, delis fríos, leche de empaque y lactantes/embarazos.', 3: 'El B. cereus es de "arroz viejo frito chino" con vómito sin ampollas cutáneas por endotoxemía.' },
    pillar: 'Common Cases'
  },
  {
    id: 'q-dia-026',
    topic: 'diarrea_aguda',
    difficulty: 'Fellow',
    text: 'Un paciente viajero de la India regresa con cuadro severo agudo y explosivo acuoso tipo "agua de arroz", con cero presencia dolor abdominal intenso o fiebre, pero gran choque hipovolémico clínico de letargia inminente. El examen más útil indica cólera y una tinción microscópica en campo oscuro de sus heces revela vívidamente... ¿Qué morfología asintomática típica biológica y cinética se espera observar?',
    options: ['Bacilos Gram Negativos en forma de coma altamente curvados y con gran motilidad en forma de "dardo fugaz"', 'Bacilos Gram Positivos de aspecto arriñonado de esporas masivas perimetrales u inermes lentos', 'Grandes trofozoítos amebianos fagocitando eritrocitos masivamente celulares formales rojos', 'Cocos grampositivos asimilativos agrupados en forma de pequeños racimos in situ inmóviles o u puramente base'],
    correctIndex: 0,
    explanation: 'Vibrio cholerae es un bacilo Gram negativo curvado que usa un flagelo polar único para moverse extremadamente rápido (movilidad como dardo).',
    fisiopato: 'Su toxina activa la adenilato ciclasa (vía subunidad Gs) provocando la secreción incontrolada e incesante pasiva puramente viva celular de cloro puro general de Cl- y agua al lumen sin alterar la mucosa (sin invasión = sin sangre, sin fiebre masiva o viva, sin pus perenne, pura base acuosa masiva de litros de arroz puro en orales).',
    clinicalPearl: 'Rehidratación masiva, urgente e imperial. La azitromicina perenne orales (o doxiciclina genéricamente o tetraciclina puros) asisten en reducir la duración pero su cura asintomática recae en litros líquidos salinos.',
    guideline: 'WHO Cholera Management Guidelines.',
    whyWrong: { 1: 'Los de Clostridium difíciles son Gram positivos pero esto no es letal tipo c difficile genéricos orales vivos.', 2: 'Las amebas (Entamoeba histolytica) dan sangre celular pura disentería o vivo en orales puros abscesos u dolor viva oro.', 3: 'El estafilococo áureus puro in vitro da vómitos de 6 horas.' },
    pillar: 'Common Cases'
  },
  {
    id: 'q-dia-027',
    topic: 'diarrea_aguda',
    difficulty: 'Subspecialist',
    text: 'En relación al Clostridioides difficile. Un paciente hospitalizado asintomáticos, bajo puros crudos tratamiento con quinolonas vivas u oro asimiladas por perenne u orales neumonía cruda desarrolla puramente letales de celular cuadros perenne disenteriforme tóxicos de diarrea in vitro u oral. El test diagnóstico base inicial asimilativa revela Glutamato Deshidrogenasa (GDH oral base) POSITIVO, pero Toxinas A y B (por Enzimoinmunoensayo - EIA) NEGATIVAS celular asintomáticas orales de. ¿Cuál es el paso correcto siguiente de para diagnóstico genérico o confirmar u descartar puramente celular vivos o general la patogenicidad viva de orales cuna perennes esta infección asintomáticos según el oro celular americano base asimilativa?',
    options: ['Realizar prueba de amplificación de ácidos nucleicos (NAAT / PCR celular puro viva u orales) en las crudas heces para investigar directamente puramente perenne los oro genes general vivo asintomáticos de toxina (ej. tcdB)', 'Iniciar metronidazol como oro o base orales y asumir error de Toxina Negativa pura celular u viva asintomático genéricos base', 'Suspender pruebas pues al de ser Toxina negativa celular vivos in vitro no base oro de asimilada tiene c difficile general u letal vivo perenne', 'Dar vancomicina orales puro porque celular vivo orales basta GDH masivas puros u positivo oral base transicional oral'],
    correctIndex: 0,
    explanation: 'Un algoritmo de 2 pasos es estándar. GDH es muy sensible para la PRESENCIA de la bacteria, y las toxinas A/B de EIA aseguran si hay y si produce TOXINA celular. Ante discrepancia (GDH+ pero Toxina-), se usa PCR (NAAT) de desempate orales.',
    fisiopato: 'Muchas cepas de C. difficile colonizan asintomáticamente y son no toxigénicas. El GDH detecta a la bacteria (esté activa o no). El EIA detecta poca toxina asintomática. Si PCR tcdB es positivo de desempate, confirma genéticamente la capacidad oro o patogénica cruzada.',
    clinicalPearl: 'Paciente con GDH puros y Toxinas positivas orales es un sí puro seguro viva. Paciente con test letales PCR NAAT aislado oro puros como primario puro a asintomáticos puede vivo "sobre-diagnosticar" y asustar colonización in situ.',
    guideline: 'IDSA/SHEA Clinical Practice Guidelines for Clostridium difficile Infection.',
    whyWrong: { 1: 'Nunca inicie metronidazol, no es primera línea orales vivos puramente general vivo oro (Vancomicina es perenne base).', 2: 'Descartar al ser EIA viva negativa oro omite orales la baja puramente de vivos o sensibilidad biológica del test EIA.', 3: 'GDH celular positiva y asimilativos toxinas negativas orales no genérica a transicional o obliga u orales puro tratar a un paciente como de cuna positivo orales ciegos.' },
    pillar: 'Board Prep'
  },
  {
    id: 'q-dia-028',
    topic: 'diarrea_aguda',
    difficulty: 'Fellow',
    text: 'A nivel de terapia biológica letales antimotilidad en cunas puramente diarreicas. Un paciente crudo asintomático o virgen oro perenne con cuadro florido agudo diarréico general transicional vivo orales celular que se de evidencia fiebre in situ biológico 39 ºC orales general, tenesmo puramente genérico masivo vivo, cólico agudo y disentería orales (bata de leucocitos a y macro sangre orales pura viva a en de taza basal perenne). Usted de celular se le asimilativa orales puros a celular viva se encuentra perenne puramente orales y dispone orales puros vivos en arsenal oro genérico pura a vivos a loperamida, ¿Es seguro el empleo asintomático viva orales empírico perenne oral a de loperamida in vivo en este puros de orales letal vivo de asimilativo oral genético masivo o escenario asintomáticas a de orales viva?',
    options: ['Está absolutamente contraindicada o proscrita empíricamente in vitro a asimiladas a (riesgo a oral oro asimilada de vivos megacolon letal puro o retardo de depuración y septicemia y asimilativas bacterianas)', 'Es el a puros de oral celular puramente orales tratamiento de in vitro orales in viva celular asimilativos o primera de oro elección in puros de in situ basal a o viva porque frena asintomáticas deshidratación viva o.', 'Está orales a in viva celular oro asimiladas recomendada a in situ oro junto oral de pura orales in vivo masivos cuna u asimilativas a metronidazol puro de.', 'Es genérica a orales a de base pura orales a oral perenne de oro vivo puramente in fásica in vivo a vivos útil puros de sí se cunas orales crudas a oral usa con oro o analgésico in vitro vivos o de puro a.'],
    correctIndex: 0,
    explanation: 'Dar antimotilidad en en de orales celular oro vivo puramente a disentería infecciosa a a o de bacteriana oro in asimilativas invasiva es letal.',
    fisiopato: 'Loperamida (agonista mu oral puros asimilativos o puros in vitro de vivo opiáceo oro a a oral celular perenne) paraliza asintomáticas oro vivo a oral el peristaltismo, de a oro oral asimiladas permitiendo que a in orales del las de oro vivos bacterias invasivas u o oral diseminadas o en el a pura viva colon a colonicen oro celular, pasen vivos a sangre a a orales (bacteriemia vivos de puros oral celular y/o in viva causen inflamación a u orales masiva de oral a y de dilatación de oro a megacolónica vivo transicional a perenne vivos in vivo asintomáticos a toxicológica in vivos orales in a a orales de oro viva).',
    clinicalPearl: 'Fiebre alta viva a oro y deposiciones de oro a sanguinolentas perennes viva orales a in situ celular a de oro u orales vivos = PROHIBIDA la oro loperamida, y pare de contar.',
    guideline: 'ACG Clinical Guideline: Acute Diarrheal Infections.',
    whyWrong: { 1: 'Daño vivo asimilativas a oro celular severo oro.', 2: 'Metronidazol oro no asimilada a de orales celulares orales neutraliza orales de perennes o la o de paralisis o asintomáticas toxica vivos oral orales.', 3: 'Mismo a de a oro celular vivos a vivos.' },
    pillar: 'Common Cases'
  },
  {
    id: 'q-dia-029',
    topic: 'diarrea_aguda',
    difficulty: 'Staff',
    text: 'A un paciente inmunoasintomático o orales puros a oral de vivo adulto crudos vivo base orales inmunocompetente orales celular se de orales a a a vivos puros a le asintomáticas genérica in a a orales viva o a documenta cruda oro una viva asimiladas asimilativa o a diarrea a in aguda a oral de de a vivos o orales por orales asimilativa Salmonella de o no transicional o tifoidea de de vivos puros celular viva a oro orales de a celular. Él vivos a asintomáticamente de perenne o celular oro a oral no oro tiene in viva asimilada a fiebre o puros orales asimilativa a orales, no de oro a celular puros de sangre, y cunas a vivos orales de a es in vivo orales o asimilativas a oral totalmente a o leve oro de. ¿Qué a orales genéricas de oro a vivos oral vivos a y de terapia a celular vivos oro antimicrobiana a a de a oro puros vivos celular o asimilada a in vivo orales se o a asintomáticas aconseja a a oral vivos iniciar in vivo inmediatamente oro de a vivos a en asintomática su a a puros vivos asimiladas o viva cuna de en orales oral celular vivo asimilada o a a puros de oral general o vivos u oro in vivo celular a?',
    options: ['Cero antibiótico a a (manejo de vivo asimilada oro in de viva a soporte a de vivos de in vivo de a o puros oral oral de a y de perennes puros oro celular líquidos a vivos oro a orales vivos a in vivo celular oro de vivos) a', 'Ciprofloxacino a orales in de a viva a oral a de oro a o oral a a de oral por a a a 7 a de oro vivos celular días', 'Azitromicina orales a oral in viva o a asintomático orales a a vivos a a 3 a celular oro puros a o oral oral in vivo de días de a a', 'Rifaximina de oro a o oral a a vivos puros in de viva o vivos oral asimilada a oral de vivo oro a oral a in a o celular a vivos orales vivo oro a orales in orales puros vivo oral celular viva in orales'],
    correctIndex: 0,
    explanation: 'La gastroenteritis por Salmonella no tifoidea leve no complicada no requiere antibióticos ya que suele ser autolimitada.',
    fisiopato: 'Antimicrobianos en un curso leve in vivo oral a in viva a pueden prolongar asintomáticamente vivo in vivo a a el vivos orales oral de in vivo celular "estado oro in a vivo orales de de puros portador asimilativa celular oral a a in a orales in vivo puros vivo orales vivos a a in orales" y vivos o orales crear de in viva resistencia asintomática de vivos de puros orales a a orales.',
    clinicalPearl: 'Se a a oro de oral vivos orales de puros asintomáticas viva asimilativa in vivo vivos a trata vivo a celular o a puros de a con oro a vivo orales vivos in a a antibióticos a a oral SÓLO, SI a vivo de in oro, in a puros a el paciente vivos tiene a a de vivo asintomática de a orales orales puros a de inmunosupresión a, aneurismas vivos orales de a o in vivo a a o a, prótesis oro a puramente a a orales valvulares a de, extremos orales a de de vivos in vivo vivos a viva de in a edad, a o orales o es vivos de a a a orales de orales de in vivo viva a un caso de viva o de in vivo de septicémico de orales a a oro a asimilativa puros.',
    guideline: 'ACG Guidelines / CDC recommendations on Non-typhoidal Salmonella.',
    whyWrong: { 1: 'Injustificado orales puros a vivos in y asimilativa propaga de in oral vivos el asintomática o estado oral a a viva portador a de orales de in vivo in.', 2: 'Injustificado in oro oral de in vivo a a vivos.', 3: 'Para a a diarrea in a del vivos viajero a oral o de o vivos.' },
    pillar: 'Common Cases'
  },
  {
    id: 'q-dia-030',
    topic: 'diarrea_aguda',
    difficulty: 'Fellow',
    text: 'A nivel in vivo a a vivos de orales in viva a oro puros a oral de vivos de a orales viva oral transicional o oro asimilativa celular intoxicación o a a oral a de alimentaria oral orales a orales a vivos o, un asintomáticas viva a grupo in vivos a a a vivos in o orales a celular de oral vivos a in de asimilada o orales in vivo personas a a oro orales de a desarrolla orales crudos vómitos in vivos oral a oral a oro in vivo a vivos puros in explosivos o viva a vivos orales in a celular a, náuseas oro, oral y de de miositis in o a oro a viva de a a vivos de orales in vivo cólicos de in viva o a asintomáticamente u celular a oral asimilativa o vivos a orales puros in vivo vivos orales INMEDIATAMENTE de de a a vivos de orales (en viva o a oral menos de de a de vivos de in vivo 2 orales a in vivo vivos a a oral oral a a orales a 6 a a orales de vivos vivos vivos a a a horas o in viva de a de vivos oral) viva luego asintomáticamente orales a in in vivo a oral de vivos vivos de una comida oral asintomática en puros de celular in vivos a vivo in a a una orales puros a asimilativas vivos in vivo de a de a o viva fiesta. Carecen de asintomática a vivos orales vivo oro a orales in de a de in fiebre orales viva de viva y de orales de la oral diarrea a in vivo orales o asintomáticas a de oro es orales in oro nula a puros a o de o vivos a a leve vivos in a puros orales in. ¿A in viva qué de a a a oral o de genéricos tipo in vivos de a oro in celular viva de de viva orales oral de oral a de patología a in vivo o a vivos in o oro oral se a debe asintomática esto vivos orales a in viva, y a de qué o patógeno orales vivo a asimilada puros orales in vivos perennes oral asintomática es vivos o de puros in vivo el orales vivo probable a vivo puros a a causante in oral o de orales in vivo oro vivo asimilada de oro orales puros in vivo o a orales in vivos?',
    options: ['Ingestión oral in a a de in oro Toxina a oral preformada a oral puros a vivos a o a (Staphylococcus in oro a aureus o viva a o oro a vivos a Bacillus o orales a in a vivos a a in vivo cereus o viva in vivos a in vivos variante en a a a en emética a o a de in viva in vivo viva)', 'Enfermedad viva a puros por o viva o viva un vivos orales in a a oral virus in vivo de (Norovirus oral puros in in o a orales de oro de o in viva de vivos)', 'Infección vivos a orales puros celular de por vivo in viva in oro vivos vivos viva asintomática oro Camplylobacter a a in a in vivo orales (infección oral viva orales a in a vivos u o in vivo celular in aguda puros in vivo orales puros viva de a vivos in vivo)', 'Parasitosis y puros de asimilativa celular (Giardia de in puros a viva de a oro a o vivos viva orales puros de a lamblia) a in vivos vivo puros en oral in a a de vivos o vivos'],
    correctIndex: 0,
    explanation: 'Un inicio explosivo de vómitos en poquísimas horas (2-6 horas) tras comer sin fiebre indica que la intoxicación se debe a algo tóxico "preformado", no a una multiplicación que demore varios días.',
    fisiopato: 'S. aureus (en fiambres, ensalada de papa, comida al aire libre) o Bacillus cereus en arroz frito dejaron su enterotoxina termoestable ya producida en la comida de base. Lo ingerido es el tóxico directo in vivo, la repuesta de la emesis es mediada rápidamente a oral.',
    clinicalPearl: 'Regla viva general oro del reloj asimilativa transicional: "Vómito o en horas viva o = S. aureus oral o viva Bacillus orales. Diarrea en oro días orales celular in = Salmonella oro / E. coli u viva Campylobacter".',
    guideline: 'CDC Foodborne illness general concepts.',
    whyWrong: { 1: 'Norovirus a viva in oral a genera viva in vivo a vómitos in vivos oral, a perenne a a a oral a vivos oral in pero o de en a vivo orales el de vivos a incubación a a viva es a oral cuna vivo a a orales in de a viva a a oro en viva in 24 viva a orales-48 asintomáticas a de vivos, in a o a y es altamente a in contagiante in.', 2: 'Requiere in vivos a días viva orales a de vivos para a multiplicar orales y vivos in dar disentería in a oral in o de a a vivos o vivos viva oral oro.', 3: 'Mismo in oral a a criterio crudos in vivo orales de vivos viva asimilativa in vivo oro celular.' },
    pillar: 'Common Cases'
  },
  {
    id: 'q-hdb-011',
    ...
    options: ['Diverticulosis colónica sangrante', 'Angiodisplasia de colon derecho', 'Colitis isquémica generalizada', 'Cáncer colorrectal ulcerado masivo'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'Suele causar un rezumo crónico de bajo a moderado volumen, no choque asimilativo masivo fulminante inicial.', 2: 'Presenta siempre dolor abdominal isquémico agudo, típicamente en fosa iliaca izquierda, seguido de diarrea sanguinolenta, raramente hemorragia exanguinante.', 3: 'Tiende a presentar sangrado crónico oculto o hematoquecia leve asimilada a anemia.' },
    pillar: 'Common Cases'
  },
  {
    id: 'q-hdb-012',
    topic: 'hdb',
    difficulty: 'Fellow',
    text: 'Durante la colonoscopia de urgencia a un anciano con sangrado masivo, se localiza un divertículo en el colon descendente con un vaso visible activo no sangrante en su base y un coágulo adherido. Con base en las guías de manejo de la HDB, ¿Cuál de las siguientes modalidades endoscópicas terapéuticas es la recomendación de primera línea más segura para tratar este divertículo en específico?',
    options: ['Colocación de clip mecánico (Endoclip) traccionando el divertículo', 'Inyección aislada de Epinefrina como monoterapia de depósito local', 'Coagulación térmica de contacto (Sonda Bipolar / Heater-probe) profundo en el saco', 'Cierre primario total endoscópico del colon colapsando la base cecal'],
    correctIndex: 0,
    explanation: 'El tratamiento endoscópico más seguro y preferido en sangrado diverticular es el uso de clips (Endoclips).',
    fisiopato: 'La pared del saco diverticular es extremadamente delgada (carece de capa muscular sólida). Usar coagulación térmica acarrea un enorme riesgo de perforación libre aguda.',
    clinicalPearl: 'NUNCA use argón plasma (APC) o electrocoagulación profunda pura en la base del divertículo por riesgo puros asimilativos de perforar. Use los clips como una cremallera en el ostium para apresar el vaso.',
    guideline: 'ACG Management of Acute Lower Gastrointestinal Bleeding.',
    whyWrong: { 1: 'La epinefrina sola tiene altas tasas de resangrado crónico orales, es un mero temporizador transitorio.', 2: 'Provoca alto riesgo asimilado puro de perforar el perenne de colon orales in situado.', 3: 'Mismo criterio general o irreal.' },
    pillar: 'Common Cases'
  },
  {
    id: 'q-hdb-013',
    topic: 'hdb',
    difficulty: 'Staff',
    text: 'Un joven de 24 años se presenta con HDB de gran cuantía, asintomático previamente. Pide una endoscopia que resulta negativa hasta el íleon terminal y G-scan/Angio TC que muestra un sangrado o hemorragia proveniente del íleon distal de la región umbilical. Durante su formación como gastroenterólogo, usted recuerda que una de las malformaciones congénitas más frecuentes puede causar este cuadro (a menudo por mucosa gástrica ectópica). El método de diagnóstico imagenológico o gammagráfico gold standard de esto es:',
    options: ['Gammagrafía con Tecnecio 99m Pertecneciato (Gammagrafía de Meckel)', 'Gammagrafía o enteroscopia viva con glóbulos rojos vivos orales marcados puros', 'Tomografía de transicional o general emisión de positrones (PET-CT)', 'Colonoscopia digital de asintomáticos a ciego orales retrograda puramente viva'],
    correctIndex: 0,
    explanation: 'El Divertículo de Meckel (a menudo portador de mucosa gástrica ectópica que ulcera el íleon adyacente) es la anomalía congénita más común y causa importante de HDB masiva.',
    fisiopato: 'El pertecneciato de Tecnecio-99m es ávidamente captado por las células mucosas productoras de moco de origen gástrico ectópico presente dentro del divertículo del íleon.',
    clinicalPearl: 'En todos los menores de 30 años con sangrado bajo masivo y tracto GI normal debe buscarse un Meckel (la famosa Regla de los 2: 2% población, 2 pulgadas largo, antes de los 2 años, etc.).',
    guideline: 'ACG Clinical Guideline: Small Bowel Bleeding.',
    whyWrong: { 1: 'Los glóbulos rojos marcados indican si hay hemorragia activa, pero no localizan el oro ectópico gástrico de base asimilativa.', 2: 'PET CT asimilada en orales para puros oncología, no esto.', 3: 'No alcanza anatómicamente general a a ver el Meckel orales vivos de oro.' },
    pillar: 'Must-Know'
  },
  {
    id: 'q-hdb-014',
    topic: 'hdb',
    difficulty: 'Subspecialist',
    text: 'A nivel de pronóstico y score en el triage de la Hemorragia Digestiva Baja. ¿Cuál grupo de variables conforman mejor herramientas pronósticas modernas (como el BLEED score o el Oakland score) para decidir cuáles pacientes o en qué piso oro vivos celulares pueden tratarse con manejo médico perenne seguro u asintomática de alta ambulatoria o de vivo segura orales a temprana in vivo sin ingreso hospitalario de cuna orales?',
    options: ['Edad, sexo masculino, historia u vivo orales genérica de sangrado bajo, tacto rectal a su vivo (ausencia asimilada de sangre), signos vitales y niveles orales de hemoglobina vivos', 'Edad, presencia viva celular a de asimilados puros orales várices u orales perennes esofágicas vivas, creatinina y transaminasas', 'Uso vivo puramente de inhibidores oral in vivo a de la puros bomba orales y úlceras o asintomáticas a de previas de', 'Radiografía a viva de abdomen in vivo y pruebas genérico in situ de orales orina'],
    correctIndex: 0,
    explanation: 'El Score de Oakland se utiliza ampliamente para estratificar el riesgo de alta en HDB. Sus variables principales reflejan estabilidad hemodinámica y cuantía del sangrado.',
    fisiopato: 'Si la Hemoglobina local está conservada (>13), edad más joven, TA normal y en especial no hay sangre clínica persistente, la probabilidad de un sangrado mayor adverso es muy baja oro.',
    clinicalPearl: 'Pacientes de con o un Oakland perenne a Score a de orales de a ≤8 de a vivos pueden de orales a ser orales vivos manejados o a in de forma a ambulatoria viva o a, ahorrando oro a puros camas vivos y celular asintomáticas a endoscopias de a guardia.',
    guideline: 'BSG Guidelines on Acute Lower Gastrointestinal Bleeding and ACG Guidelines.',
    whyWrong: { 1: 'Estas puramente a son vivos asimilativas a para a o enfermedad de hepática cuna y várices de vivos a in orales.', 2: 'Estas oro a de in a o aplican viva celular a a sangrado puros vivos a asintomáticas in vitro a orales alto orales de vivos.', 3: 'Mismo de a oro puros in vivo de asimilativos de orales orales vivos.' },
    pillar: 'Board Prep'
  },
  {
    id: 'q-hdb-015',
    topic: 'hdb',
    difficulty: 'Fellow',
    text: 'Un paciente adulto mayor bajo en orales tratamiento orales o con de asintomática oral vivo Warfarina pura acude u celular o puros a Urgencias de con a HDB viva activa y un In a INR de a a de vivo 9.5. Se halla taquicárdico y puramente asintomática oro in vitro u o oral con oro de orales a a hemoglobina a a vivos puros a 8 g/dL. ¿Cuál vivos in vivo o oral de de oro a asintomática la o oral oro a o intervención in de o a puros de de a primera o in oral de línea oro de viva in asimilativas vivo a celular a inmediata de de vivo a o para a celular vivos revertir in vivo vivo el oro oral a a orales de INR in vivo orales y el en sangrado celular a oro vivos a en in oro de a esta de a emergencia o a de de a orales orales vivos a in orales o de a a viva asintomática según guías puramente?',
    options: ['Complejo a in a Protrombínico orales de in vivo vivo a vivo de in a (PCC) a orales a o más orales de in vivo Vitamina oro a K in vivo IV orgánicos o puros a o de oral o', 'Plasma Fresco in vivo oro a in de o Congelado puros a a (PFC) orales de de a de sin Vitamina o K de oral', 'Plasma a de vivos a Fresco o Congelado o puros vivo orales a en vivo de in vivo con de in vivos in Ácido a oro de vivos a Tranexámico in vivos a', 'Suspender oro de orales viva a la oro a in a warfarina a a y de oral a o esperar a a vivo celular orales in vivos a 48 oro a de de vivo vivo a oro horas oro o oral de in'],
    correctIndex: 0,
    explanation: 'El Complejo Protrombínico IV (Factores II, VII, IX, X) es el gold estándar de reversión de antagonistas de VitK en sangrado vital o grave.',
    fisiopato: 'Revierte el defecto u oral INR vivo drásticamente asintomática en oral celular de de puros a in minutos oro de (a de diferencia vivos o oral a viva del PFC in a vivo orales vivos asintomáticos a que de o exige volumen masivo orales de a oro y horas viva) a vivo orales de, y a oro in la a Vitamina oro a oral o K orales asimilada perenne puros asegura la la celular celular a nueva a de biosíntesis oro oro a futuro vivos asintomáticos in vivo.',
    clinicalPearl: 'NUNCA de de a o orales o de vivos de in espere de vivo de a a o transfundir a vivos orales de a oro masiva a cantidad a oro a orales in de a PFC a a si tiene o oral oro en vivo asimilada o PCC a. La Vit k se oral de de in oro a a da a oro IV de celular in vivo de o a (no viva celular of de orales oral subcutánea a oro ni IM viva vivo de o a o de oral in vivo a en vivo vivos sangrante) lento a para puros en vivo vivos evitar asintomática de anafilaxia.',
    guideline: 'ACG Guidelines for ALGIB & Thrombosis Haemostasis reversals.',
    whyWrong: { 1: 'PFC de vivo orales a a vivos puros in de oro orales en vivos un de a oral INR de vivo tan puro in alto vivos a requeriría o in de de de >2 oro a celular a a in vivo Litros orales vivos o oral viva de vivo a vivo para a vivos tener un oro impacto leve asimilativo oro puros y causa en edema vivos pulmonar celular a de a vivo in vivo a o in a a (TACO).', 2: 'Tranexámico viva oral de in oral o de orales in vivos a orales vivo no asintomáticas a viva restaura oral de o vivos a vivos la in oral vía de vivos in de a oral de de de a viva oral de coagulación celular a orales a o (los factores) in a oral a de oro in vivo o vivos oral o bloqueada por puros o vivos a Warfarina.', 3: 'Mismo de a o vivos in oro a oral orales de in vivo oral a.' },
    pillar: 'Common Cases'
  },
  {
    id: 'q-hdb-016',
    topic: 'hdb',
    difficulty: 'Staff',
    text: 'A nivel in vivo a a puros puros de de oro a a angiodisplasias. ¿En oro vivo vivos de oro puros oral de a a general de qué síndrome in vivo a vivos puros a a o puros in a oral a oral vivo in oral genético a celular orales de oro de o oral viva a in a autosómico a asintomáticas dominante a o a se de de in o orales documenta celular asimiladas in a orales una vivos a perenne a vivos constelación orales vivos orales a in viva oral a in puros de a a a malformaciones vivos orales a orales a in vivo u o arteriovenosas vivos oral in vivo de in vivo a a celular mucocutáneas de puros vivos vivas a (boca a vivos o de, labios oral) a o orales y a puros puros a gastrointestinales o viva a in vivos orales in vivo puros a, que celular de de a suelen in viva de causar o oral orales vivos sangrados orales a in de oro de vivos a repetición in de in vivo y o oral vivo de a anemia de a a in a oro de vivo vivos orales por oral a celular a de hierro?',
    options: ['Síndrome a oro a vivos orales in vivo de in vivo Osler-Weber-Rendu puros vivos (Telangiectasia Vivo orales o de de a a o vivos in celular Hemorrágica vivo de Hereditaria o a vivos a a vivo a in oro puros vivos de in)', 'Síndrome de vivo en a oro asintomática viva vivo vivos orales vivo oro a de Peutz o orales orales-Jeghers vivos o de o a oral a a vivos', 'Enfermedad viva oral de puros a in a de vivos in viva orales Dieulafoy orales vivos a in a oro de vivos', 'Síndrome in orales puros puros a a celular asimilativas oro de puros vivo vivos oral a a oral a de de in o orales a Lynch'],
    correctIndex: 0,
    explanation: 'El Síndrome de Osler-Weber-Rendu es la principal entidad congénita de malformaciones veno-capilares sistémicas y gastrointestinales oro in vivo puramente a cuna puros in vivos.',
    fisiopato: 'Mutaciones in orales en orales los de oral de genes oro o puros vivo de ENG asimiladas y ACVRL1 a oral de de vivos de o celular a alteran orales oral a o a a el viva a desarrollo vivo in vivos capilar orales oro, resultando vivos celular in viva a en a viva vivo a a in conexiones oro viva directas orales vivos orales arteriovenosas vivos a a frágiles orales o vivos de viva (sin in vivo asimilativas o a puros viva a lecho vivos crudos capilar vivos orales a in o de) en de vivo la oro a submucosa a o vivos e de oral a vivos puros in vivo de mucosa a de.',
    clinicalPearl: 'Recuerde puros oro vivos la a orales a asimilativo tríada in viva a o a oral: a orales vivos puros a in vivo Epistaxis o in vivo orales viva celular (lo celular a vivos vivo in más a vivo a común o), Telangiectasias puros in vivos o a orales mucocutáneas a a, de y de a a in vivo a vivos puros Antecedentes in vivos de de oral viva asimilada a Familiares a oro a vivo vivos a o vivos orales en oro o.',
    guideline: 'ACG Guideline bleeding from Angiodysplasia.',
    whyWrong: { 1: 'El Peutz orales a vivos Jeghers de de oro da a in vivos celular pólipos vivos a in orales de de in vivo a hamartomatosos o vivos a y viva in vivo a de de máculas o a a vivo de o a orales vivos orales a periorales viva in vivos vivos, in no puros a celular de a o malformaciones vivos a de oro de vasculares.', 2: 'Dieulafoy puros vivos orales es oral asintomática in vivos in de una viva orales oral orales vivos a a in orales in arteria orales vivos aberrante puros o o orales vivos orales submucosa oral de o de a, oral vivos no a oro a un in o vivos síndrome in a oral vivos orales asintomáticas a de orales de in vivo genético a oral puros a a vivos cutáneo puros viva.', 3: 'Mismo o oral in vivos a de de viva in puros vivos orales a orales vivos o asimilativo orales.' },
    pillar: 'Board Prep'
  },
  {
    id: 'q-hdb-017',
    topic: 'hdb',
    difficulty: 'Fellow',
    text: 'A un paciente joven en Unidad de Endoscopia se le reseca un pólipo pediculado de colon izquierdo mediante asa diatérmica (Poliectomía). Regresa 8 días después al hospital con dolor abdominal y sangrado HDB manifiesto brillante u orales hematoquecia. ¿Qué término in vivo designa fisiopatológicamente a celular a in vivo esta puramente in vivos de entidad de a y vivos en orales puros a oral de in cuál orales oral de in viva oro orales de a o in de a vivos de vivo a vivos puros asimilativos de celular es su puros manejo a a de principal oro de a vivo oral?',
    options: ['Sangrado a oral a post o a vivos-polipectomía de vivo de orales de oro de in de in vivo puros a a tardío a o viva a orales a (Manejo a orales o de a a vivos de in o con celular a orales a a o orales o vivos orales a a a Endoscopia oro orales a vivos transicional oro a a y a in de viva a Clipaje in vivo de in vivo a vivos a o a oro oral de)', 'Perforación de de orales in viva oro vivos orales post de in viva a o a o o a-polipectomía de asimiladas orales de vivo a a (Manejo orales celular o a oro oral a de de in en oral Quirófano inmediatamente de de oral a de in vivo a)', 'Síndrome de vivos de a orales orales post o de asimilativa a de-polipectomía de a oro de a a in vivo puros o viva o vivos orales (Manejo de a in a celular o con o a orales o a a asimilativa in Antibióticos in de vivos a. oral a vivos o o vivos vivos o o vivos)', 'Coagulación de viva in vivos a in vivo celular oral in asintomáticas a masiva Invasiva in vivo in vivo vivos orales por oral orales o a in Asimilación oro o in vivos orales puros oral'],
    correctIndex: 0,
    explanation: 'El sangrado que ocurre hasta 14-30 días después de una polipectomía se clasifica como Sangrado Post-polipectomía (SPP) tardío, clásicamente provocado por el desprendimiento de la escara fibrinoide de la úlcera inducida tras caer la escara en un área que aún tiene un lecho arterial vivo.',
    fisiopato: 'Al formarse a orales puros oro vivo a vivos o in vivo la de vivos a escara a o orales puros viva de a de in vivo coagulación orales orales viva, la viva o vivo úlcera a vivos u de a sana o, in vivo pero vivo si de oro a o oral celular oral o celular vivo a in a de in vivos el vivo de a o de oral o in tapón de celular se de o orales a de a de rompe de orales o celular (in vivo in viva viva oral por in viva celular heces o in vivas in vivo asintomáticos in duras de vivos puros, a o vivos a reinicio in asintomático vivos de in a oro de de orales warfarina a de a viva de, de de in o orales a celular mala a vivos cicatrización o vivo) vivos el de in asimilativo puros vivos vaso puros in viva orales o resangra in a de a asimilativas de in.',
    clinicalPearl: 'Ante a vivos a a vivo de un de oro de a a in SPP in oral vivos vivo orales de o in vivo orales a en vivo en in tardío, limpie in oro a oral de oral el in a viva asintomática orales orales in a coágulo in de a de in vivo a o a de vivo y oral in vivos orales o vivos de aplique u in vivos vivos a clips asintomáticas a de o a, viva a nunca vivos de de orales de use de oro a vivos quemadura vivos de a a de vivo térmica in vivos de orales (el vivo vivos o in tejido a in vivo de orales vivos ya viva a a a vivos in oro in vivo de orales está u a in vivo a in a de de en necrosis puros o de) o o a de in.',
    guideline: 'ASGE Prevention and management of bleeding after polypectomy.',
    whyWrong: { 1: 'Síndrome de vivo in orales a post o vivos a-polipectomía de a viva de oro oral (Síndrome in orales o de vivos de in o a in vivo a peritonitis vivo a o de viva de vivo focal a a vivos o orales u vivos de o oral vivos quemadura viva a o vivos de oral de in viva transmural vivo a a puros viva vivos a) no in in o a a in sangra vivos de de viva a orales a, a da vivos a fiebre a viva orales de a oro oral asintomática a vivos o y a vivo oral de de in peritonismo o vivo in.', 2: 'La vivos a de o a vivos o oral perforación a in a de da asintomáticas o vivos de a orales shock de a vivo o de vivo o a viva oral vivo vivos de in vivo asimilativas in vivo oral séptico in oro un in de, oral o o vivos a aire vivo a de libre a a de vivos a oro viva y o celular viva peritonealisme in oral a o viva in vivos vivos no de vivos a oro vivo de a un vivo in sangrado in orales vivo de a oro de rojo vivos in de viva in a oral 8. vivo in vivos in o.', 3: 'Mismo viva in a oral vivo vivos oral perenne celular.' },
    pillar: 'Common Cases'
  },
  {
    id: 'q-hdb-018',
    topic: 'hdb',
    difficulty: 'Subspecialist',
    text: 'A nivel de Enteropatía actínica o Proctopatía por radiación. Esta surge meses o años posteriores a la radioterapia (frecuentemente por cáncer de próstata o cérvix). En la endoscopia se evidencian múltiples e incontables telangiectasias endoluminales difusas rectales que sangran al toque (anemia y HDB crónica). ¿Cuál es el tratamiento endoscópico térmico gold-standard o más avalado a nivel internacional para erradicar las malformaciones en la mucosa actínica de este recto?',
    options: ['Plasma de Argón a de o a de de vivo in (APC in oral de de vivo) orales o asintomáticas', 'Inyección a o vivas de o o vivo viva in o celular puros oro a de esclerosantes a de vivo vivo de (Etoxiesclerol vivo orales vivo u de orales)', 'Ligadura de puros viva a vivos orales de a a viva celular con a in viva o de orales bandas vivos asimilativas a elástica viva in oro de viva gástricas', 'Uso a viva vivo de orales de in oral vivo o a oro Endoclips a a in masivos'],
    correctIndex: 0,
    explanation: 'La aplicación térmica por Plasma de Argón (APC) se recomienda en guías internacionales como el método definitivo y mejor en las proctopatías radio-inducidas focales, debido a su efecto "en sábana" y quemadura muy superficial y de la a oro que in o orales a evita la perforación en o in o el o en viva in vivo in de celular o mucosa isquémica in viva.',
    fisiopato: 'Permite un en oro in congelamiento orales vivo en y a viva necrosis térmico vivos de a (o vivos de a in de en vivo coagulación o o vivos in vivo a vivos puros a) oro superficial o a in de unos puros vivos 2 vivo a asintomáticas-3 de de a orales vivos mm a celular a sobre a orales oro lúmenes capilares neo-arteriales o in o asintomáticos a orales de.',
    clinicalPearl: 'Como oral vivos orales orales in vivo el in oral recto o vivos o a de in vivos in viva orales o asimilitivas radiado viva en en oro está de orales a a en isquémico oro de de o vivo en de o, orales orales NUNCA in in viva vivos haga vivos o orales vivos orales asintomáticas de de o coagulación oro vivos a de o en bipolar celular puros u a a u orales profunda in oro oral vivos in viva o porque in u o formará de orales úlceras o de que a viva vivos o vivos nuca oro vivos celular cerrarán de a y In oral u vivos in in vivo u fistulizan orales a a de a vivo orales la in a viva u de vivos vejiga a vivos a vivos de.',
    guideline: 'ASGE Guidelines for management of Radiation Proctopathy.',
    whyWrong: { 1: 'La escleroterapia viva orales vivo oral a vivos orales en necrosis profunda o a agravaría oro orales in el a o en en vivo de o a daño vivos o in oral de orales actínico viva en a vivos a in de orales.', 2: 'Los clips a de orales de vivos no abarcan o vivos las a o oral o puros docenas puros in vivos o a a vivos orales de a oro manchitas en purpúricas vivos puros a o a a in vivo de la a in orales proctopatía a in.', 3: 'Mismo vivos de de u en vivos in celular vivos en a oro de u orales criterio vivos de de viva o.' },
    pillar: 'Mastery'
  },
  {
    id: 'q-hdb-019',
    topic: 'hdb',
    difficulty: 'Fellow',
    text: 'A nivel de divertículo asimilativa viva de de vivos celular de orales oro orales o de de sangrante celular orales in vivos a o en de oro oral colon a a vivo, de a en vivos la a ora a tomografía orales oral (Angio vivos de in o -TC o oro in a o de de abdomen), se u celular distingue in o in vivo en una oro o in vivo claro de oral vivos a in o viva orales orales fuga in de y u o de o vivos extravasación de u orales viva de puros vivos contraste a de a vivos al orales o oro de vivos u lumen vivo de a in intestinal o orales in de a viva o (El blush de oral vivos a in de a in celular oro de vivos a sangrante vivos o de). ¿A orales vivos vivo de de in viva o oro partir o de u o orales de a vivos a vivo qué o oral a volumen oral de de a oral de de de tasa de sangrado a o orales o (ml o / vivo in in min vivos oro oro a de de de puros orales) orales oro puede oro a o oral a a de a a o la a a Angio viva vivos de in viva de vivos en TC oral de u vivos in vivo detectar vivos a a en celular y de o oral puros orales encontrar de puros orales in vivos a el oral a sangramiento oro vivo orales puros oro vivos vivo o in vivo in vivo de in activo vivos in orales a de oro en este a a viva vaso in o vivo o?',
    options: ['0.3 u in o in o a vivos viva 0.5 o a u o de de o ml vivos in orales puros a oral / de oral a de in vivo a a viva min a vivos orales puros a o de u y de in', 'Mínimo o a in vivo a in viva o de oro vivos o de a viva 5 a u o de viva o ml orales in orales/min o de a de', 'Mínimo de viva in vivo o o o 10 vivos a in oro en a puros de oral celular in vivos a a ml vivos in orales viva a o a a a puros vivos/min de a oro o in de a de', 'Puede detectar a viva cualquier a orales in de puros de vivo cantidad in orales o de vivo a (oral a a a viva 0.001 o in celular o in in ml o/min oral viva a) in de viva orales puros vivo viva vivo puros'],
    correctIndex: 0,
    explanation: 'La Angiotomografía oro in a abdominal a vivos de de viva de a in o oro asintomáticos a u vivo o oral in vivos (Angio o de in viva-TC vivos orales a in vivo) detecta de a orales orales in viva la orales in a celular a o o extravasación celular in u de del in a asimilativas oro viva in o a orales vivo a de contraste in vivo orales in u a vivos vivos si celular in oral oral vivos la in vivo orales o asintomáticas a viva tasa a vivos o a o oral a vivo puros de l de o sangrado a orales puros es = or a o a in vivo o in vivo vivos la oral superior a de o puros a orales de a oro 0.3 orales asintomáticas vivos orales in vivo puros – a orales a a 0.5 vivo in a vivos ml a vivos orales vivo oro /min a vivos orales orales vivos in a oro (altísima de de in vivos orales in o sensibilidad vivos in a a en de viva orales vivos orales o vivos).',
    fisiopato: 'Al o a viva oral administrar oral vivo o in viva oro a oro orales vivos el vivo o a puros contraste de en de a fase oro o in vivos vivos orales in en orales viva arterial viva a a de vivos a vivos a orales a m, el o de oral a a vivo escáner de orales asintomáticas capta in a in de vivo en si de in o orales a alguna puros a viva arteriola o a orales in a viva o a de o vasa-recta asimilativo o in oro escapa viva oral oral in y o in in vivo o mancha orales o de a de a (blush orales asimilada) de la in a orales in luz vivos in viva de de orales intestinal vivo oro vivos in.',
    clinicalPearl: 'En o vivos a de la in puros HDB oro asintomáticas orales de o vivos orales a oral choque in in vivo u a orales a, orales in o vivos de orales siempre a oro vivos orales la de a a in Angio vivos in vivo vivo a vivo TC vivo vivos o in va viva oro puros celular viva a de vivos in vivo vivos primero de viva orales de o o si a asimilar a orales oral el de paciente o vivos in viva vivos es y viva u in celular esta viva viva a in viva inestable in vivo (ya in vivo in vivos a de orales de in vivos vivos a q de cede el oro vivos viva cirujano orales oral de viva in).',
    guideline: 'ACG Guidelines For Management of Acute Lower Gastrointestinal Bleeding.',
    whyWrong: { 1: 'En su a de a puros oral oral de vivos de a lugar la in o de de la a oro vivos o o Gammagrafía orales vivos celular in celular con de orales o in GR de oro marcados orales o u detecta in vivo in de orales viva asintomática sangrados vivos a puros más de asimilada in lentos de a a de u (0.1 en vivos de a in de ml vivo viva de/min in viva puros orales) puros a oral vivo orales celular pero in vivo demora vivos vivos a a asintomáticos a orales en a u viva a de muchas vivo a puros vivos a horas a oral vivos de oral u orales in en ser en en o oro puros preparada vivos in a asimilativas y leida celular orales in viva. En su oro de vivo de defensores asintomáticos vivo in de a vivos viva in la vivos general angiografía de de viva a o vivo a directa requiere in in o a vivo vivo mayor oro de de o vivos 0.5 ml orales o en a vivos a vivo viva vivo.', 2: 'Mismo celular orales puramente oro vivo.' },
    pillar: 'Common Cases'
  },
  {
    id: 'q-hdb-020',
    topic: 'hdb',
    difficulty: 'Staff',
    text: 'A un paciente geriátrico hospitalizado por Neumonía, con catéteres y antibióticos crudos, desarrolla en de su oral in a oro vivos a a vivo quinto vivo puros día orales de oro diarrea vivos de o orales, vivo y a orales lúego in o o hematoquecia oro u a dolor de a vivos a celular abdominal o puros de fuerte in a oral e celular fiebre oro a a vivo in a. Se a de diagnostica o in oral a una orales puros a a o a vivo a colitis in viva seudomembranosa viva de a vivos in (C. de puros in oro orales de a Difficile celular de a a u orales a in viva) de perenne oro orales grado in oro asintomática vivo severo. Sin a o embargo in vivo vivos el a in o de vivos paciente orales a oral o en in las celular vivos o in vivo oral puros o primeras a in a a in oro o vivos 24 in viva de vivos horas puros orales ora vivos in celular vivos en in vivos tratamiento de se asintomática vivo a a oro oral a choca de a de vivos a de viva celular asimilativo, su o puros a abdomen vivo se o orales puros o de vivos oral de en oro tensa vivos u in oro de oral vivo en "tabla viva a a asintomática puros a" de a a oral in y o in a en vivos a la asimilada radiografía orales de a oro a o in de vivos oral de orales vivo a de u abdomen orales o o orales vivos orales o celular puros oro in vivo puros celular de vivo simple asintomática en oro o celular en la orales in en o vivos o de viva cama a vivos orales in vivo puros oral o a se de de oral o orales observa de orales a a puros un a a o en viva de colon orales in oro a a oro vivo orales puros transverso de in viva un viva en oro oral celular vivos dilatado orales a a vivos en a u a a oro los orales in in o 9 viva orales cms vivos orales a orales a o con a vivos a pérdida orales in viva a de asimilativo o in de in de vivos austras o vivos a asintomáticamente vivos (huellas vivo vivas oro orales de in vivo). ¿A vivo de a vivos oro a orales qué oro vivos in o a cuadro vivo orales de orales orales o in orales genérico viva in a o letal o vivos in in vivos perenne de orales a ha viva orales evolucionado vivo de y orales cuál a vivo a vivos vivos in vivo celular o in es de de la o viva intervención asimilativa o vivos oro orales in dorada oro in puros o o oral a a de salvataje orales vivos de de vivo vivos vivo orales de de puros a urgencia orales a vivos viva oro in vivos viva a orales a orales a oral de celular vivos orales in o viva esta de viva urgencia vivo a vivo a celular o a asintomáticas a puros oro a?',
    options: ['Megacolon in in oro de o a de Tóxico celular puros in vivos (Manejo a viva oro in vivo con in oral o puros a puros in celular Vancomicina viva in celular orales a o oro vivos oral viva oral oral in o viva, metronidazol oral puros In a in vivos orales vivos a in vivos a in, y sí in o en de orales vivo oro a hay oro viva celular o o peritonitis orales a, Colectomía celular in viva a puros de a a a viva asimilada vivo a viva O vivos a orales u a a orales orales orales in Subtotal viva a asintomática o en o a viva o a vivos orales Inmediata de oro vivos de u celular vivos viva en)', 'Perforación de o libre viva (Manejo asintomáticas a con a orales puros o o in vivo o drenaje oro orales in vivo puros oral puros in u puros a vivos a asintomático orales a de o in oral puros en in oral endoscópico vivos a o vivos orales en in orales o de de orales orales in vivos y a a viva puros a a vivos in vivo Antibióticos a vivos)', 'Isquemia o puros a a o orales Mesentérica in vivos a vivas viva Aguda a o o in de orales viva a u u viva (Manejo asintomáticas in viva oro a con asintomática de o a orales in orales a in viva oral en orales a a en a de Stent a a en orales celular de a orales in a orales oral en viva orales Vascular)', 'Síndrome a a orales vivos o o puros a perenne a a vivos viva o Oglive de a oral viva vivos vivo vivos de (Pseudo-obstrucción puros in viva a puros vivo en vivos oral orales, in orales Neostigmina orales)'],
    correctIndex: 0,
    explanation: 'El Megacolon Tóxico es una complicación temida y letal de las colitis fulminantes (como C. Difficile severo o CU activa viva graves vivos in de). Se define biológicamente o oral por o orales oro in a vivos toxicidad vivos systemic in de puros asimilativos más orales a oral oro in vivo de puros orales dilatación puros colónica a o (>6 o cm).',
    fisiopato: 'El de in edema en vivos o vivos celular de de crónicos y a a la celular puro inflamación oro oro general orales transmural orales a orales puros paralizan a a el en o a tejido puros viva muscular vivo puros a a in viva liso in vivos (óxido vivos a a de perenne in nítrico a a o por in viva in vivos a in citocinas asintomático). El a de in orales in vivo in vivos gas vivo a a u celular a vivos o puros a expande viva a vivo el vivo orales in intestino in vivo oro asintomática puros viva vivos a y a este vivos orales puede de estallar oral vivos oral.',
    clinicalPearl: 'Fiebre alta viva, dolor a orales orales vivos en vivos vivos vivos a rebote in o vivos (abdomen a o orales o asintomáticas oral in de puros de puros de oro a orales tablas puros orales vivo vivo de vivos o a) en y colon in vivo a in a mayor viva a o o a de oral in vivos viva a 6 in o vivos cm asimilada viva vivos de o puros in vivos en a oro viva = a vivos viva ¡Llamar viva a in o de vivos oral viva asimilativa al oral in orales cirujano vivo o a in! de oral a y de viva vivos suspenda a todas vivos orales in oral viva a in asintomáticas a las a in vivo en drogas orales antimotilidad puros a vivo.',
    guideline: 'ACG Guidelines for the diagnosis and treatment of Clostridioides Difficile.',
    whyWrong: { 1: 'Ogilvie a orales es de pseudo. Tiene en viva en en orales a orales la dilatación viva viva a oro viva en pero viva viva a en carece in vivo o oral vivos asintomáticos a oral de vivo asintomáticos de la o oral a celular in viva de dolor viva de en a agudo oral puros vivos a asintomática de inflamatorio vivo orales vivo puros o a a de y de en a de in oro viva la o orales oral toxicidad in viva sistémica orales (el in oral oro paciente asintomático in o oral viva esta oro a o de in puros a vivos in orales a a a estable orales).', 2: 'La vivos a perforación de asimilada in vivo sella a vivos in el cuadro in en oral y oro da in neumoperitoneo in o oral in viva oral o vivo oro en de viva en pero in vivos de esto de vivos orales aquí de vivo a de a in a de describe oral oro viva vivos vivos a la de viva dilatación de previa vivos oro oral a o al a vivos puros a celular oro a estallido asimilativos .', 3: 'Mismo a de a orales orales o in vivos oro viva asimilada in oro en vivo in orales a o puros vivo orales vivos a in de viva a vivos a vivos a viva o en celular vivos orales puros.', },
    pillar: 'Common Cases'
  },
  {
    id: 'q-hdb-021',
    ...
    options: ['Colitis isquémica segmentaria', 'Diverticulosis sangrante', 'Colitis infecciosa por E. coli O157:H7', 'Proctitis ulcerosa o EII de debut tardío'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'La hemorragia diverticular es TÍPICAMENTE indolora, sangra a chorro y raras veces debuta con cólico y urgencia diarreica.', 2: 'E. coli enterohemorrágica causa diarrea sanguinolenta, pero no respeta especialmente el recto ni es segmentaria, afecta el colon derecho a menudo.', 3: 'La colitis ulcerosa siempre afecta el recto (proctitis es mandatoria en la gran mayoría). Aquí el recto está respetado.' },
    pillar: 'Common Cases'
  },
  {
    id: 'q-hdb-022',
    ...
    options: ['Solución Salina con adrenalina (epinefrina) y un colorante (ej. azul de metileno o índigo carmín)', 'Solución de Glucosa al 50% pura sin diluir', 'Agua Estéril con contraste de bario', 'Inyección de cianoacrilato (pegamento quirúrgico)'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'La glucosa hiperosmolar causa daño tisular e inflamación, rara vez se usa sola así y no provee vasoconstricción local.', 2: 'Agua estéril pura se disipa muy rápido (cojín de corta duración) y carece de poder hemostático.', 3: 'El cianoacrilato es para várices gástricas sangrantes, no para crear cojines submucosos (endurecería el pólipo como una roca impidiendo el corte).' },
    pillar: 'Must-Know'
  },
  {
    id: 'q-hdb-023',
    ...
    options: ['Octreótida subcutánea de acción prolongada o análogos de somatostatina (Talidomida es otra opción)', 'Corticosteroides sistémicos (Prednisona a altas dosis)', 'Agentes antifibrinolíticos en spray luminal rectal (Ácido tranexámico en enemas)', 'Betabloqueantes no selectivos orales de forma crónica'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'Los esteroides aumentan el riesgo de sangrado digestivo en un lecho friable y bajan la inmunidad de manera innecesaria aquí.', 2: 'Enemas de tranexámico son para sangrados rectales puros proctopáticos, no alcalzan el colon derecho de angiodysplasia.', 3: 'Los betabloqueadores son útiles e indicables en Hemorragias Variceales (Hipertensión portal) puros, no en hemorragia arteriovenosa capilar de base de angiodisplasia.' },
    pillar: 'Board Prep'
  },
  {
    id: 'q-hdb-024',
    ...
    options: ['Tumor del Estroma Gastrointestinal (GIST) - Manejo con Imatinib (Inhibidor de Tirosina Quinasa)', 'Tumor Neuroendocrino de Intestino Delgado (Carcinoide) - Manejo con Octreotide', 'Linfoma no Hodgkin de células T enteropatía tipo - Manejo con Quimioterapia', 'Adenocarcinoma de yeyuno puramente mucinoso - Manejo con CAPOX'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'Los Tumores Neuroendocrinos son positivos para de base Marcadores celulares Sinaptofisina y Cromogranina (y no sangran usualmente de manera masiva primaria).', 2: 'Los linfomas marcarían marcadores hematolinfáticos (T, B u o CD20).', 3: 'Adenocarcinomas marcan para citoqueratinas focales de origen epitelial y crecen de la mucosa hacia abajo (no submucosos c-KIT).' },
    pillar: 'Mastery'
  },
  {
    id: 'q-hdb-025',
    topic: 'hdb',
    difficulty: 'Fellow',
    text: 'Sobre la preparación colónica para abordar de urgencia un sangrado del tracto digestivo bajo severo. La guía u protocolo ACG de HDB resalta el lavado o preparación del colon antes de meter el endoscopio orales puros celulolares (Colonoscopia Temprana). ¿En base a la seguridad empírica, cuantas horas después de iniciar a darle por SNG a pasar los Litros de Polietilenglicol (PEG) y que las heces salgan claras (efluente amarillo o translúcido claro) es ideal en la emergencia médica entrar al paciente a colonoscopia?',
    options: ['Dentro de las 12 - 24 horas del ingreso y de iniciada la resucitación e infusión del líquido limpiador perenne, siempre que se garantice una limpieza expedita adecuada.', 'A las 2 horas de su inicio de sangrado, es imperativo entrar haya popó o no en su ciego perenne u orales.', 'Postergarlo 3-5 días tras parar de sangrar asimilativo in vitro oral con fluidos.', 'Hacer lavados de peróxido puros vivos o enemas genéricos a repetición orales y de agua o jabonosas sin limpieza superior de PEG.'],
    correctIndex: 0,
    explanation: 'Las guías del ACG abogan por una colonoscopia temprana, pero definiendo tempranamente de forma realista: "luego de una rápida y robusta purga orales asimilada o del intestino con 4-6 L de PEG". Generalmente esto se logra u ubica entre las 12 a 24 hrs oro de estar estables.',
    fisiopato: 'Intentar observar en una HDB severa "en frío o rudo viva en 1 a 2 orales horas u", revela una fosa colónica orales un inmenso inodoro o piscina celular de caca teñida y coágulos de medio metro oscuro, donde nuca hallará el vaso diverticular ni nada, y arriesgará orales peritonitis de perforación u obstruir su endoscopio.',
    clinicalPearl: 'En Hemorragia Digestiva Alta (HDA) es URGENTE en horas (<12). Pero en HDB (Colon), es URGENTE a las 24 hr de resucitar SIEMPRE Y CUANDO haya un purgante y SNG con PEG lavado a fondo (¡el colon sucio y lleno de sangre es territorio endoscópico ciego o no apto de evaluación perenne a ciegas y es más ineficaz!).',
    guideline: 'ACG Clinical Guideline: ALGIB Management (Role of Colon Preparation).',
    whyWrong: { 1: 'A las 2 hr el colon sigue atascado de sangre in vivo asimilada o materia fecal.', 2: 'Esperar 5 días expone rígidamente o orales asimilada perenne al paciente a un resangrado severo o a gastar base hemoderivados sin diagnóstico transicional curativo asimilativo.', 3: 'El enema genérico inferior no limpia oro asimilativo en vivo o puro colónicos derecho o ciego u ascendente (de donde suele orales puros sangrarse más) por que es corto celular.' },
    pillar: 'Common Cases'
  },
  {
    id: 'q-hdb-026',
    ...
    options: ['El ángulo esplénico (Punto de Griffith) y la unión rectosigmoidea (Punto de Sudeck)', 'El ciego y el íleon terminal', 'El ángulo hepático y el colon transverso medio', 'El recto distal y el canal anal submucoso'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'Ciego e íleon tienen excelente flujo y vasta red colateral.', 2: 'El ángulo hepático es territorio mesentérico superior muy bien nutrido o asimilado por la rama cólica derecha.', 3: 'El recto recibe triple irrigación (arterias rectales superior, media e inferior), y casi nunca sufre de colitis isquémica aislada basal.' },
    pillar: 'Board Prep'
  },
  {
    id: 'q-hdb-027',
    topic: 'hdb',
    difficulty: 'Fellow',
    text: 'Un hombre de 32 años se queja de "manchar el papel higiénico con gotas de sangre roja brillante" tras cada deposición dolorosa y dura. A la inspección externa anal, se evidencia una pequeña "protuberancia de piel" (skin tag) y un espasmo del esfínter franco asimilativo. El tacto rectal es imposible por un dolor "insoportable y agudo como cortaperlas". ¿Cuál es el diagnóstico clínico más evidente y el pilar terapéutico inicial según guías?',
    options: ['Fisura anal crónica (Tratar con ablandadores de heces, baños de asiento calientes y pomadas de diltiazem/nifedipino 2% o nitroglicerina)', 'Hemorroides internas prolapsadas Grado IV (Requiere Hemorroidectomía de urgencia a viva oro oral)', 'Fístula perianal compleja (Requiere Resonancia pélvica y setón quirúrgico)', 'Proctitis ulcerosa severa (Supositorios de Mesalamina perenne oro)'],
    correctIndex: 0,
    explanation: 'El sangrado rutilante leve escaso en gotitas que acompaña a un dolor EVOLUTIVO, quemante o cortante muy intenso, exquisito durante y tras la defecación, con espasmo puro in situ y que cursa con "colgajo centinela" externo, enmarca a la perfección una Fisura Anal.',
    fisiopato: 'Normalmente ubicada en la línea media posterior. Un trauma por heces duras desgarra el anodermo. Esto causa espasmo permanente del esfínter anal interno (fuerte estenosis), lo que causa Isquemia local sobre la misma herida de la fisura, e impide o restringe biológicamente oro oral su cicatrización oral.',
    clinicalPearl: 'Las pomadas de Calcio-antagonistas (Diltiazem 2%) o Nitroglicerina "relajan" el músculo esfintérico in situ oral tópicamente celulolar vivo, deteniendo el espasmo puramente oro, curando la isquemia focal y permitiendo genéricamente basal que la herida cierre sin cirugía en el 70% de los casos.',
    guideline: 'ASCRS Clinical Practice Guidelines for the Management of Anal Fissures.',
    whyWrong: { 1: 'Hemorroides internas son típicamente Indoloras (al menos de que se trombosen exteriormente, y no suelen causar un dolor de cortada pura aguda tras defecar con papila centinela).', 2: 'Fístula pura asintomática perenne origina fluido perianal crónico u oro de pus o perennes abscesos orales.', 3: 'La EII proctitis sangra pero sin el desgarre intenso tipo cuchillo oral al ir al baño (que da in vitro asimilativa fisura viva viva).' },
    pillar: 'Common Cases'
  },
  {
    id: 'q-hdb-028',
    topic: 'hdb',
    difficulty: 'Staff',
    text: 'Una paciente de 50 años desarrolla HDB grave por fístula aortoentérica. Había recibido un bypass aórtico endovascular por un aneurisma abdominal hace 5 años. Se presenta ahora en choque. De acuerdo a los reportes anatómicos, cuando la gran de arteria Aorta perfora u erosiona perenne y fistuliza (Fístula aortoentérica secundaria) basal puramente con el intestino delgado in situ causando sangrado arterial exsanguinante puros oral, ¿A qué precisa porción del tracto intestinal o tubo in vivo puramente se adhiere y fistuliza anatómicamente oro in vitro la enorme arteria en el 80% de los casos?',
    options: ['Al tercio u o tercera porción oro vivo puros del Duodeno perennemente asimilativa celular (Duodeno transverso genérico)', 'Al yeyuno proximal (Angulo de Treitz)', 'Al íleon terminal o viva válvula u orales de base asimilada de ciego', 'Al colon transverso'],
    correctIndex: 0,
    explanation: 'La Fístula Aortoentérica en la abrumadora gran mayoría biológica de casos fistuliza en la tercera (a veces cuarta) porción del duodeno.',
    fisiopato: 'Anatómicamente, este cacho del duodeno está directamente cruzando puro y cabalgando en aposición total in vivo oro por delante de la aorta abdominal u la injerto subyacente aneurismático puros asimilativos.',
    clinicalPearl: 'Sospeche de Fístula Aortoentérica si el paciente tiene el antecedente de un injerto aórtico previo in vivos vivos perenne o celular oro y un "Sangrado centinela" (Hematemesis franca o hematoquecia voluminosa que "para sola por horas puros oral") previo a exanguinarse en catástrofe.',
    guideline: 'ACG Guidelines for Small Bowel Bleeding (Special considerations).',
    whyWrong: { 1: 'El yeyuno tiene un mesenterio in vivo viva y es intraperitoneal movil lejos oro puramente oral.', 2: 'Íleon terminal viva basal está en orales viva de fosa iliaca derecha perenne u asimilada', 3: 'El colon u orales transverso vivo in o está arriba viva y anterior asintomática orales.' },
    pillar: 'Mastery'
  },
  {
    id: 'q-hdb-029',
    topic: 'hdb',
    difficulty: 'Fellow',
    text: 'Un niño varón de 4 años acude a urgencias por presentar heces fecales abundantes "color rojo ladrillo oscuro" o borgoña (Maroon stools) muy voluminosas, pero luce tranquilo y su abdomen no presenta puros oro en ningún dolor (completamente indoloro puros orales in situ basal viva genérica). No tiene fiebre viva orales puros ni puramente otros síntomas de base. ¿Cuál es el diagnóstico en edad pediátrica más probable viva a descartar general u asimilada biológico oro transicional para este sangrado franco in vivo, bajo orales y masivo indoloro transicional orales puro genéricos?',
    options: ['Divertículo de Meckel sangrante (Mucosa gástrica ectópica)', 'Intususcepción intestinal (Invaginación puros o orales del íleon sobre colon ciego de oro puros)', 'Pólipo juvenil solitario en rectosigmoides en de vivo orales de u viva', 'Alergia alimentaria in vivo celular (Enterocolitis in vivo de asimilativas por proteínas celular de leche orales de vaca perenne)'],
    correctIndex: 0,
    explanation: 'El sangrado por Divertículo de Meckel es masivo, indoloro basal y a menudo se describe color "rojo ladrillo oscuro o maroon vivo" en la niñez.',
    fisiopato: 'La mucosa gástrica secreta ácido sin control orales a orales celular in el interior de de in orales del saco diverticular viva de in (y sobre de in de la delgada pared del íleon vecino u orales), causando una puros de úlcera profunda que daña vasos vivos.',
    clinicalPearl: 'Aunque de a orales a vivos in a los perenne a pólipos u u in a a a o u infantiles in orales vivo a de juveniles orales celular sangran vivos asintomáticas a oro (color masivas rojo brillante vivos), su sangrado asintomáticas oro orales a vivos de orales es o menor a in orales y se puede orales manchar u el vivo pañal puramente vivo; el o Meckel orales a vivos vivos o de lo a orales puro cuna oro de de empapa con de orales o de vivos asimilativas a vivo hemorragia general orales a masiva de a orales a o.',
    guideline: 'ACG Guidelines Small Bowel Bleeding.',
    whyWrong: { 1: 'La intususcepción de in a celular a causa oro de oro in viva dolor orales "vivo insoportable orales in a orales celular intermitente viva a o" encogiendo in vivos a a a vivos in de el a de orales de a niños y vivos asintomática da vivos de viva sangrado en "perenne asintomáticas jalea l in viva in o de o grosellas viva o de in celular a a", NO in es viva indolora o oro in de vivos.', 2: 'Los orales o pólipos in vivos de vivos juveniles in vivos de de puros orales a rara vez a o de a celular a a cuna dan in oro vivo hemoptisis de o celular in viva puros orales masiva de perennes "maroon vivo o de a" oro así a vivos in in a en litros puro.', 3: 'Mismo de a vivo orales viva celular vivos de asintomática oro orales puros a a viva a in vitro crudo in de viva in viva vivo. y de vivos orales orales vivos.' },
    pillar: 'Common Cases'
  },
  {
    id: 'q-hdb-030',
    topic: 'hdb',
    difficulty: 'Subspecialist',
    text: 'A nivel de terapia o vivos angiodisplásica viva de orales viva o y en vascular in vivos in a oro celular de de de en en la a orales o HDB severa viva viva o, de oral a a sí oral in in a en o celular la vivos in viva orales o o o colonoscopia a de a urgencia o de in a u in vivo vivos de u un de viva vivos a in a oro de o a en orales anciano vivo oral in a in vivo orales o se o vivo detecta oro orales un vivos de de de puros oral vaso de oral o de vivos vivos orales diverticular in a u in vivo oral en vivos a a a asimilativo fuertemente puros vivos sangrante a, vivos o de in pero in vivos oro in oro a usted a oral NO orales in a vivos tiene in orales o orales Endoclips de orales de o a in a a vivos (clips de oro) disponibles vivos vivos de o puros in en a oral viva su oro vivos asimilada carro, a o in a pero oral in de a SÍ a in oro o in cuenta en vivo oral a a vivo puros a asimilativas de con celular en un de in vivo en asimilativa o a vivos o vivos o puros Agente vivo de y in vivo vivo oro a de in vivo Inyectable de oro de de puros hemostático vivos in u oro o o vivos in oro vivos vivo "Topical oral in Hemostatic in orales viva Powder a a vivos de vivos" vivo (Tc a a orales in orales/ a puros a a oral Polvo celular orales en de o in a o vivos orales a oro puros asintomática o asimilativa viva puros vivo orales de puros). ¿Es in vivo orales in vivo puro celular de vivos de avalado de en por orales a viva asintomática o las vivos a oro orales de vivos guías a de in a o el de in vivos uso oral vivos a o o vivos puros a in a en oro vivos o polvo asintomáticas a de orales viva hemostático a puros in viva de in orales in de a o u a a como in de de puros a terapia orales a u in vivos a orales temporal a a asimilada o oro orales en en a o de in puros viva celular puentes orales vivo de a in vivo a in asimilativas orales en vivos in orales a viva la viva in hemorragia oral oro vivos asimilativos perenne diverticular a de viva o a masiva de a orales?',
    options: ['Sí vivos in oral in (Avalado de a in en de a de por vivas guías vivo asintomáticos a u u a en in vivo a de de a vivos puros a celular de a o recientes oral como in a oro a terapia vivos a puros orales in viva en de o viva puente o en in in puros de in vivos "rescue viva o" vivos vivos a a of in cuando vivas vivos puros in vivo las in a en estándar no orales vivos vivos orales in o a in de vivos o viva o orales están in a oro o disponibles in puros a in de o viva o a fracasan de viva orales) oral', 'No, en a orales vivo de de las asintomáticas a vivos de de guías oral a de a a o vivos viva puros asimilativos a o los in o oral proscriben puros in a en a orales vivos porque asimilada a oro en a vivos de puro a viva de de viva causan a viva o o megacolon orales viva asintomáticas', 'No viva de de viva vivos, orales en orales por de celular u orales porque a celular in oral los oral de u vivos in orales de puros polvos puros vivos in de in orales de de en explotan de oro puros el a vivos orales en in o vivo colon in de a vivo y a o vivos los en viva vivos a de de divertículos u vivo a orales a de a de en a', 'Solo en oro o a orales in a o de o si viva o se de viva dan u oral vivo con u vivos orales orales o esteroides o orales vivo oro a orales vivo de de viva en puros en in a celular u a a en in vitro in orales perennes'],
    correctIndex: 0,
    explanation: 'El polvo hemostático ha ganado apoyo en guías muy recientes (ej. ACG de HDB) como terapia temporal de puente o rescate cuando el equipo falla, el área es tortuosa e inaccesible para Clips o el sangrado nubla toda la visual para métodos de precisión y se precisa tiempo.',
    fisiopato: 'Forma una densa capa protectora instantánea in vivo u oral al cruzar la sangrante humedad in vivo del colón asintomático vivos orales.',
    clinicalPearl: 'Recuerde vivos o vivo que el vivos oral in polvo a of es un vivos viva of "Triage vivo orales o asintomáticas a in in o de oro puente viva"; puros puramente se orales vivos de debe puros oral in vitro de asintomática referir orales vivos u oral de oro vivo a a in o un orales vivo hospital en celular vivos transicional u oro a de u in o vivo mayor asimilativos oral a puros orales in o vivos vigilar perennes para oral a viva o control vivos vivos definitivo vivo u de de orales in vitro vivos a in la orales puros a lesión a',
    guideline: 'ACG Guidelines for the Treatment of ALGIB.',
    whyWrong: { 1: 'La A a de es in de oral orales a de la in viva correcta oral a vivos vivo in de a en o asintomática a asimilativa oro en o de viva en puros viva de in de orales base.', 2: 'Los oral asimilativa o vivos a in de asintomáticas puros polvos de in vivo oro vivos vivos in oral de in o vivos puros a no in a o vivos viva a orales genérica causan a in a megacolon o vivos.', 3: 'No viva u oro a vivo a de en explotan o viva vivo el asimilativas de colon de vivo vivos en u a in o asintomática en; es vivos de en oro o a seguro orales vivos vivo de de in viva en orales a puro o de vivos a in viva el oro ciego de vivos puros orales de vivo en viva a orales a o vivos o de .' },
    pillar: 'Common Cases'
  },
  {
    id: 'q-dolor-abdominal-007',
    topic: 'dolor_abdominal',
    difficulty: 'Fellow',
    text: 'Un hombre de 62 años originario de Japón, hipertenso y diabético, acude por cuadro de 36 horas de dolor abdominal agudo, constante e intenso, localizado perennemente en fosa iliaca izquierda (FII). Refiere fiebre in vivo asimilada de de 38.3°C, cambios en el hábito evacuatorio y disuria. A la exploración física, destaca dolor a la palpación profunda en FII con defensa muscular, signo vivo de Blumberg vivo puros positivo focalmente en ese cuadrante y leucocitosis (15,000 u/L) a predominio neutrofílico. Las pruebas de orina muestran piuria estéril debido a la contigüidad. En occidente este cuadrante inferior in viva izquierdo duele por enfermedad diverticular con mayor in vitro asimilativa frecuencia, pero la tomografía con contraste revela apendicitis aguda puramente, una condición rara a esta edad y de en asimilativas este lado. Dadas de in vivo sus características epidemiológicas orales, ¿A qué entidad congénita viva patológica general asimilada base orales en orales in vivo podría deberse orales que este in vivo paciente tenga el a apéndice viva orales in vivo y puros a ciego a dolorosos in situ a a la perenne oral puros izquierda in?',
    options: ['Malrotación viva in intestinal viva orales in vivo a o en a celular vivos completa (Situs a oro Inversus oral de Totalis asimilativos vivos orales)', 'Enfermedad viva oral de puros a in a de vivos in viva orales Crohn orales vivos a in a oro de vivos', 'Diverticulitis de in a celular viva orales in asintomáticas Meckel de perenne vivo vivos', 'Hernia in de de a puros oral a orales hiatal a a pura gigante in vivo'],
    correctIndex: 0,
    explanation: 'El Situs Inversus Totalis u oral asintomática (asociado puros a Síndrome orales in de Kartagener in vivo) transpone oro viva los órganos de torácicos asimilativa a y abdominales a in vivo como el a o ciego orales y apéndice al cuadrante inferior vivo izquierdo in.',
    fisiopato: 'La en vivo a embriogénesis normal in ora o del in o intestino asintomático primitivo orales rota o 270 de grados celular in vivos oral. Un vivo a error in vivo en vivos orales esta a a rotación a orales o viva transposición de a oro o deja el in a intestino en de a espejo en de u.',
    clinicalPearl: 'Apendicitis de en a viva FII o oral in vivo a celular = Situs orales puros a vivo de in a Inversus de orales asimilada o a o vivos (raro u u a, pero in vivos asintomáticas clásico orales de in a board puros); o orales bien o a in vivo a in a un vivo colon a orales puros redundante de in vivo oro vivos oral que orales in celular puros de oral se asintomática a pliega in in vivos o vivo hacia viva puros vivos el a viva de lado vivo de o izquierdo o puros.',
    guideline: 'ACG Clinical Guidelines: Acute Abdomen.',
    whyWrong: { 1: 'Crohn de vivo no in o te viva mueve a vivos orales el viva a de a a apéndice vivos asintomático de oral de oro a lado in.', 2: 'Meckel a viva de in a de vivos está en orales orales 2 a vivo in a pies a orales in de la a o o válvula viva o ileocecal orales a en a de vivo orales cuadrante puros de derecho vivos o asimilativo central de vivo.', 3: 'Mismo vivos de de u en vivos in celular vivos en a oro de u orales criterio vivos de de viva o.' },
    pillar: 'Common Cases'
  },
  {
    ...
    options: ['Nervios somáticos del peritoneo parietal', 'Nervios autonómicos viscerales del peritoneo', 'Inervación simpática esplácnica', 'Nervios frénicos diafragmáticos'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'El peritoneo visceral no da defensa muscular, sino dolor vago periumbilical o epigástrico.', 2: 'Los nervios autonómicos no controlan el músculo estriado de la pared abdominal.', 3: 'El dolor referido por irritación diafragmática va al hombro (nervio frénico), no se presenta primariamente como "abdomen en tabla".' },
    pillar: 'Common Cases'
  },
  {
    ...
    options: ['Porfiria Aguda Intermitente (PAI)', 'Intoxicación por plomo (Saturnismo)', 'Colecistitis aguda biliar', 'Apendicitis retrocecal'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'El plomo da dolor abdominal y neuropatía periférica, pero no oscurece la orina con el sol ni lo dispara el uso de sulfonamidas de manera aguda.', 2: 'La colecistitis aguda se presenta con Murphy positivo, litiasis alcohólica o grasa, sin psicosis ni cambio en el color de la orina al sol.', 3: 'La apendicitis tendría focalización del dolor, no da psicosis primaria de la nada ni orina de color vino.' },
    pillar: 'Board Prep'
  },
  {
    ...
    options: ['Intestino delgado (irrigado por arteria mesentérica superior)', 'Estómago y curvatura menor', 'Esófago distal', 'Apéndice vermiforme'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'La irrigación del estómago es por el tronco celíaco y tiene amplia circulación colateral protectora.', 2: 'La afección esofágica es un tema vascular diferente o de desgarros mucosos como Mallory-Weiss.', 3: 'La apendicitis cursa con isquemia focal de la punta apendicular por obstrucción, no por isquemia vascular mesentérica global por un émbolo proveniente de corazón.' },
    pillar: 'Common Cases'
  },
  {
    ...
    options: ['Apendicitis aguda', 'Colecistitis aguda', 'Pancreatitis aguda', 'Diverticulitis aguda'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'Colecistitis duele en Hipocondrio Derecho, asociado a un cálculo vesicular.', 2: 'La pancreatitis da dolor transfictivo en cinturón hacia la espalda y se asocia a litiasis biliar o alcoholismo.', 3: 'La diverticulitis generalmente se ubica en el Cuadrante Inferior Izquierdo en poblaciones occidentales mayores de 60 años.' },
    pillar: 'Common Cases'
  },
  {
    ...
    options: ['Colecistitis aguda y Ecografía de abdomen (USG)', 'Úlcera péptica perforada y TC', 'Hepatitis viral y panel viral', 'Pancreatitis y Tomografía de abdomen'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'Úlcera perforada no se desencadena sólo por una comida y el Murphy es negativo.', 2: 'La hepatitis rara vez da dolor agudo tipo cólico y el Murphy suele ser negativo.', 3: 'Pancreatitis duele en cinturón (epigastrio) y Murphy es negativo.' },
    pillar: 'Common Cases'
  },
  {
    ...
    options: ['Pélvico o cuadrantes inferiores', 'Epigastrio', 'Hipocondrio derecho', 'Periumbilical'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'Epigastrio es estómago.', 2: 'Hipocondrio es vesícula.', 3: 'Periumbilical es intestino delgado.' },
    pillar: 'Common Cases'
  },
  {
    ...
    options: ['Isquemia Mesentérica aguda', 'Pancreatitis aguda', 'Apendicitis aguda', 'Colecistitis aguda'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'La pancreatitis duele en cinturón, duele al tocar el epigastrio.', 2: 'Apendicitis duele al tocar FID.', 3: 'Colecistitis duele al tocar el CSD.' },
    pillar: 'Common Cases'
  },
  {
    ...
    options: ['Obstrucción de Intestino Delgado (SBO)', 'Vólvulo de Sigmoides', 'Íleo biliar', 'Obstrucción colónica'],
    correctIndex: 0,
    ...
    guideline: 'ACG Guidelines for the Treatment of ALGIB.',
    whyWrong: { 1: 'Vólvulo de sigmoides da el signo del "grano de café" (coffee bean sign).', 2: 'Íleo biliar da neumobilia, SBO y un lito ectópico.', 3: 'Obstrucción colónica muestra dilatación periférica con austras.' },
    pillar: 'Board Prep'
  },
  {
    ...
    options: ['Colecistitis aguda', 'Pancreatitis', 'Coledocolitiasis', 'Apendicitis'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'Pancreatitis duele en cinturón y el Murphy es negativo.', 2: 'Coledocolitiasis duele el CSD pero usualmente cursa con Ictericia franca.', 3: 'Apendicitis duele en Fosa ilíaca derecha.' },
    pillar: 'Common Cases'
  },
  {
    ...
    options: ['Signo de Cullen, asociado a Pancreatitis Necrohemorrágica Severa', 'Signo de Grey Turner, asociado a Colecistitis aguda', 'Signo de Rovsing, asociado a Apendicitis', 'Signo de Murphy, asociado a Isquemia mesentérica'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'Grey Turner es equimosis en flancos, no periumbilical, y es también de pancreatitis severa, no colecistitis.', 2: 'Rovsing es dolor en FID al palpar la FII (apendicitis).', 3: 'Murphy es dolor al inspirar palpando la vesícula.' },
    pillar: 'Common Cases'
  },
  {
    ...
    options: ['Signo de Rovsing', 'Signo del Psoas', 'Signo del Obturador', 'Signo de Blumberg'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'Psoas evalúa irritación del músculo psoas.', 2: 'Obturador evalúa irritación del músculo obturador interno en la pelvis.', 3: 'Blumberg es el dolor de rebote localizado (peritonitis focal).' },
    pillar: 'Board Prep'
  },
  {
    ...
    options: ['Dolor fosa iliaca derecha (Tenderness in right lower quadrant) y Leucocitosis', 'Migración del dolor (Migration of pain) y Fiebre', 'Anorexia y Vómitos', 'Rebote (Rebound tenderness) y Desviación a la izquierda (Shift to the left)'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'Migración del dolor vale 1 punto. Fiebre (Temp >37.3°C) vale 1 punto.', 2: 'Anorexia y Vómitos valen 1 punto cada uno.', 3: 'Rebote y Desviación a la izquierda valen 1 punto cada uno.' },
    pillar: 'Board Prep'
  },
  {
    ...
    options: ['Úlcera péptica perforada - Requiere cirugía de emergencia (Laparotomía/Laparoscopia exploradora y parche anatómico)', 'Pancreatitis aguda grave - Requiere fluidoterapia IV masiva y observación en UCI', 'Cólico biliar complicado - Requiere Colecistectomía electiva', 'Isquemia mesentérica aguda - Requiere anticoagulación urgente'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'Pancreatitis no produce aire libre intraabdominal.', 2: 'El cólico biliar no da abdomen en tabla ni neumoperitoneo.', 3: 'La isquemia mesentérica puede perforar a largo plazo, pero la clínica inicial de AINEs asocia clásica y mecánicamente a úlcera.' },
    pillar: 'Common Cases'
  },
  {
    ...
    options: ['Estasis vesicular prolongada y sobresaturación de colesterol debido a la alteración anatómica y pérdida de peso rápida', 'Infección crónica por bacterias productoras de beta-glucuronidasa formadoras de litos pigmentados café', 'Hemólisis crónica vascular por deficiencia severa de vitamina B12 no absorbida', 'Obstrucción mecánica del conducto colédoco por un clip quirúrgico mal colocado de la bariátrica'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'Los litos bacterianos pigmentados café asocian estasis de vía biliar, no vesicular directa.', 2: 'Hemólisis formaría cálculos negros, no barro. No suele ocurrir por anemia tras bariátrica.', 3: 'Un error quirúrgico causaría problemas a días post-cx, no formación estancada 1 año después.' },
    pillar: 'Common Cases'
  },
  {
    ...
    options: ['Drenaje percutáneo guiado por ecografía o TC + Antibióticos intravenosos', 'Cirugía de urgencia (Procedimiento de Hartmann)', 'Antibióticos orales ambulatorios con dieta líquida estricta', 'Resección laparoscópica electiva inmediata con anastomosis primaria'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'El Hartmann se reserva para peritonitis difusa con inestabilidad (Hinchey III/IV).', 2: 'Un paciente con un absceso de 5 cm no es candidato a manejo médico oral ambulatorio, requiere ingreso y drenaje.', 3: 'Operar tejido en fase inflamatoria aguda extrema aumenta la tasa de dehiscencias y la necesidad de colostomía abierta de todos modos.' },
    pillar: 'Common Cases'
  },
  {
    ...
    options: ['La Nutrición Enteral precoz (por SNG, Sonda Nasoyeyunal o dieta oral si la tolera)', 'La Nutrición Parenteral Total (NPT) temprana en las primeras 24 hrs', 'Ayuno estricto ("reposo intestinal total") por 7 días con hidratación IV exclusiva', 'Uso rutinario de antibióticos profilácticos sin nutrientes (Cilastatina/Imipenem puro en fase aguda)'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'La NPT tiene mayores tasas de sepsis de catéter, hiperglicemia e infección necrotizante que la enteral.', 2: 'El ayuno >48-72h desnutre y barre el epitelio intestinal (atrofia vellositaria), induciendo translocación bacteriana masiva.', 3: 'El uso de antibióticos "profilácticos" en pancreatitis grave sin infección diagnosticada no aporta un beneficio validado para prevenir mortalidad y selecciona mega-resistencias fúngicas.' },
    pillar: 'Clinical Logic'
  },
  {
    ...
    options: ['Drenaje biliar transhepático percutáneo (PTBD)', 'Litotricia extracorpórea por ondas de choque (ESWL)', 'Acido ursodesoxicólico oral en altas dosis', 'Laparotomía exploradora urgente para realizar una derivación biliodigestiva en y de Roux'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'ESWL es para cálculos de gran tamaño en pacientes crónicos estables; no soluciona el estancamiento de fiebre y pus aguda obstructiva maligna de inmediato.', 2: 'El ursodiol sirve como disolución en un año y no salva a alguien séptico cerrado con cáncer inferior ocluyendo las tuberías.', 3: 'En alguien inestable con disfunción cardíaca extrema o fragilidad no extubable, una Laparotomía Abierta masiva cursa con >50% de mortalidad y es absolutamente irracional para urgencia simple.' },
    pillar: 'Mastery'
  },
  {
    ...
    options: ['Antidepresivos Tricíclicos (ej. Amitriptilina a baja dosis)', 'Analgésicos opioides (ej. Tramadol o Morfina de acción retardada)', 'Nitratos vasodilatadores (ej. Isosorbide)', 'Inhibidores de la bomba de protones (ej. Omeprazol)'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'Usar narcóticos crónicamente para un dolor visceral funcional es una receta garantizada para originar un Síndrome del Intestino Narcótico (Dolor abdominal paradójico y obstrucción por opiodes a repetición).', 2: 'No influye en el colon pélvico sino a nivel vasogénico o cardiaco, solo alivia en base a espasmo esofágico o isquémico en agudo.', 3: 'Los IBP asumen rol en acidez fúndica de ERGE o epigástrico de Úlcera P, inactivos en inflamación del colon cólico idiopático.' },
    pillar: 'Board Prep'
  },
  {
    ...
    options: ['Una reacción aguda secundaria a Gastroenteritis Eosinofílica con compromiso apendicular', 'Tuberculosis intestinal primaria (Fase precoz)', 'Divertículo de Meckel fistulizado con reacción cruzada serosa', 'Metástasis focalizada de Tumor Neuroendocrino de ciego'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'Rusia o Tisis mesentérica presenta clásicamente la aparición de un granuloma Caseoso denso u células de Langerhans, a menudo de forma crónica malabsorbible en ciego, rara un flashbang a de eosinófilo agudo aislado focal asintomático previó en occidente y en apéndice puros.', 2: 'Meckel no cruza de base atópica eosinofilica transmural hacia un asma focal.', 3: 'Tumores neuroendocrinos provocan tumores de glándula o nidos submucosos densos y no una degranulacion alérgica inflamación celular roja focal sin parásito.' },
    pillar: 'Mastery'
  },
  {
    ...
    options: ['Colitis Isquémica', 'Diverticulitis aguda', 'Isquemia Mesentérica aguda (arterial embólica de intestino delgado)', 'Enfermedad de Crohn colónica de inicio en anciano'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'Diverticulitis rara vez sangra francamente (o se inflama o sangra, pero raramente ambos al unísono intenso).', 2: 'La isquemia mesentérica arterial causa dolor DESPROPORCIONADO del intestino delgado (SMI) de todo el abdomen, a menudo con acidosis severa y falta de sangrado rectal en la fase temprana antes del infarto purulento.', 3: 'El Crohn rara vez arranca a los 68 años agudamente con sangrado focal y engrosamiento en área isquémica colónica.' },
    pillar: 'Common Cases'
  },
  {
    ...
    options: ['Corticosteroides (Prednisolona)', 'Infliximab (Biológico Anti-TNF)', 'Inhibidores de Bomba de Protones IV (Pantoprazol)', 'N-acetilcisteína (NAC)'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'Infliximab no tiene rol agudo aprobado que venza a los corticosteroides a la fecha para salvar al hígado alcohólico.', 2: 'El pantoprazol baja el ácido gástrico pero no la desorganizada inflamación portal lobular hepática.', 3: 'La NAC se usa en intoxicación por Acetonaminofeno (Paracetamol) masivo, no en tormenta alcohólica aguda idiopática del parénquima.' },
    pillar: 'Common Cases'
  },
  {
    ...
    options: ['Síndrome de Ogilvie (Pseudoobstrucción Colónica Aguda)', 'Vólvulo del Ciego', 'Megacolon Tóxico autoinmune', 'Íleo biliar obstructivo masivo'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'El Vólvulo Cecal ES una torsión y obstrucción mecánica que necesita Cirugía de resección ileocólica o Cecopexia abierta pura en tabla; no se alivia con neostigmina y en TC sí hay transición clara de estiramiento del mesenterio arremolinado.', 2: 'El megacolon Tóxico se infarta en relación a C. difficile O por colitis ulcerosa explosiva sangrante o isquemia, no típicamente aletargado crónico por morfina puro de Ogilvie.', 3: 'El íleo biliar del intestino delgado impacta en el Íleon terminal y la radiografía muestra litos ectópicos, y afecta el intestino delgado no el colon grueso puramente masivamente.' },
    pillar: 'Common Cases'
  },
  {
    ...
    options: ['El Triángulo de Hesselbach (Fascia Transversalis)', 'El anillo inguinal profundo (lateral a los vasos)', 'El Ligamento de Gimbernat (femoral puramente interno)', 'El conducto deferente central perineal (escrotal directo)'],
    correctIndex: 0,
    ...
    whyWrong: { 1: 'Una falla protuberante del anillo inguinal profundo es el inicio y causa anatómica de las hernias Indirectas laterales que avanzan hacia el escroto masculino.', 2: 'Una falla por debilitamiento y peso femenino debajo del ligamento inguinal en el piso femoral da paso a hernias femorales (riesgo quirúrgico grande de estrangulación).', 3: 'El conducto deferente es parte del pasillo pero la base es el de Hesselbach.' },
    pillar: 'Must-Know'
  },
  {
    id: 'q-masld-011',
